...
class DeductionTransactionController extends Controller
{
     ...
     */
    public function edit(DeductionTransaction $deductionTransaction)
    {
        //
    }
     ...
     */
    public function update(UpdateDeductionTransactionRequest $request, DeductionTransaction $deductionTransaction)
    {
        //
    }
