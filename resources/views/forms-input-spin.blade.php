                ...
                <div class="flex flex-wrap gap-4">
                    <div class="inline-flex text-center input-step">
                        ...
                        <input type="number"
                            ...
                            value="10" min="0" max="100" readonly>
                        <button type="button"
                            class="transition-all duration-200 ease-linear bg-white border dark:bg-zink-700 dark:border-zink-500 ltr:rounded-r rtl:rounded-l w-9 h-9 border-slate-200 plusBtn text-slate-500 dark:text-zink-200 hover:bg-custom-500 dark:hover:bg-custom-500 hover:text-custom-50 dark:hover:text-custom-50 hover:border-custom-500 dark:hover:border-custom-500 focus:bg-custom-500 dark:focus:bg-custom-500 focus:border-custom-500 dark:focus:border-custom-500 focus:text-custom-50 dark:focus:text-custom-50"><i
                                data-lucide="plus" class="inline-block w-4 h-4"></i></button>
                    </div>
                    <div class="inline-flex text-center input-step">
                        <button type="button"
                        ...
                        <button type="button"
                            class="transition-all duration-200 ease-linear bg-white border dark:bg-zink-700 dark:border-zink-500 ltr:rounded-r rtl:rounded-l w-9 h-9 border-slate-200 plusBtn text-slate-500 dark:text-zink-200 hover:bg-green-500 dark:hover:bg-green-500 hover:text-green-50 dark:hover:text-green-50 hover:border-green-500 dark:hover:border-green-500 focus:bg-green-500 dark:focus:bg-green-500 focus:border-green-500 dark:focus:border-green-500 focus:text-green-50 dark:focus:text-green-50"><i
                                data-lucide="plus" class="inline-block w-4 h-4"></i></button>
                    </div>
                    <div class="inline-flex text-center input-step">
                        <button type="button"
                        ...
                        <button type="button"
                            class="transition-all duration-200 ease-linear bg-white border dark:bg-zink-700 dark:border-zink-500 ltr:rounded-r rtl:rounded-l w-9 h-9 border-slate-200 plusBtn text-slate-500 dark:text-zink-200 hover:bg-orange-500 dark:hover:bg-orange-500 hover:text-orange-50 dark:hover:text-orange-50 hover:border-orange-500 dark:hover:border-orange-500 focus:bg-orange-500 dark:focus:bg-orange-500 focus:border-orange-500 dark:focus:border-orange-500 focus:text-orange-50 dark:focus:text-orange-50"><i
                                data-lucide="plus" class="inline-block w-4 h-4"></i></button>
                    </div>
                    <div class="inline-flex text-center input-step">
                        <button type="button"
                        ...
                        <input type="number"
                            ...
                            value="30" min="0" max="100" readonly>
                        <button type="button"
                            class="transition-all duration-200 ease-linear bg-white border dark:bg-zink-700 dark:border-zink-500 ltr:rounded-r rtl:rounded-l w-9 h-9 border-slate-200 plusBtn text-slate-500 dark:text-zink-200 hover:bg-sky-500 dark:hover:bg-sky-500 hover:text-sky-50 dark:hover:text-sky-50 hover:border-sky-500 dark:hover:border-sky-500 focus:bg-sky-500 dar:focus:bg-sky-500 focus:border-sky-500 dark:focus:border-sky-500 focus:text-sky-50 dark:focus:text-sky-50"><i
                                data-lucide="plus" class="inline-block w-4 h-4"></i></button>
                    </div>
                    <div class="inline-flex text-center input-step">
                        <button type="button"
                        ...
                        <button type="button"
                            class="transition-all duration-200 ease-linear bg-white border dark:bg-zink-700 dark:border-zink-500 ltr:rounded-r rtl:rounded-l w-9 h-9 border-slate-200 plusBtn text-slate-500 dark:text-zink-200 hover:bg-yellow-500 dark:hover:bg-yellow-500 hover:text-yellow-50 dark:hover:text-yellow-50 hover:border-yellow-500 dark:hover:border-yellow-500 focus:bg-yellow-500 dark:focus:bg-yellow-500 focus:border-yellow-500 dark:focus:border-yellow-500 focus:text-yellow-50 dark:focus:text-yellow-50"><i
                                data-lucide="plus" class="inline-block w-4 h-4"></i></button>
                    </div>
                    <div class="inline-flex text-center input-step">
                        <button type="button"
                        ...
                        <button type="button"
                            class="transition-all duration-200 ease-linear bg-white border dark:bg-zink-700 dark:border-zink-500 ltr:rounded-r rtl:rounded-l w-9 h-9 border-slate-200 plusBtn text-slate-500 dark:text-zink-200 hover:bg-red-500 dark:hover:bg-red-500 hover:text-red-50 dark:hover:text-red-50 hover:border-red-500 dark:hover:border-red-500 focus:bg-red-500 dark:focus:bg-red-500 focus:border-red-500 dark:focus:border-red-500 focus:text-red-50 dark:focus:text-red-50"><i
                                data-lucide="plus" class="inline-block w-4 h-4"></i></button>
                    </div>
                    <div class="inline-flex text-center input-step">
                        <button type="button"
                        ...
                        <button type="button"
                            class="transition-all duration-200 ease-linear bg-white border dark:bg-zink-700 dark:border-zink-500 ltr:rounded-r rtl:rounded-l w-9 h-9 border-slate-200 plusBtn text-slate-500 dark:text-zink-200 hover:bg-purple-500 dark:hover:bg-purple-500 hover:text-purple-50 dark:hover:text-purple-50 hover:border-purple-500 dark:hover:border-purple-500 focus:bg-purple-500 dark:focus:bg-purple-500 focus:border-purple-500 dark:focus:border-purple-500 focus:text-purple-50 dark:focus:text-purple-50"><i
                                data-lucide="plus" class="inline-block w-4 h-4"></i></button>
                    </div>
                    <div class="inline-flex text-center input-step">
                        <button type="button"
                        ...
                        <button type="button"
                            class="transition-all duration-200 ease-linear bg-white border dark:bg-zink-700 dark:border-zink-500 ltr:rounded-r rtl:rounded-l w-9 h-9 border-slate-200 plusBtn text-slate-500 dark:text-zink-200 hover:bg-slate-500 dark:hover:bg-zink-500 hover:text-slate-50 dark:hover:text-zink-50 hover:border-slate-500 dark:hover:border-zink-500 focus:bg-slate-500 dark:focus:bg-zink-500 focus:border-slate-500 dark:focus:border-zink-500 focus:text-slate-50 dark:focus:text-zink-50"><i
                                data-lucide="plus" class="inline-block w-4 h-4"></i></button>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-wrap items-center gap-4">
                    ...
                    <div class="inline-flex text-center input-step">
                        ...
                        <input type="number"
                            ...
                            value="40" min="0" max="100" readonly>
                        <button type="button"
                            class="transition-all duration-200 ease-linear bg-white border dark:bg-zink-700 dark:border-zink-500 ltr:rounded-r-full rtl:rounded-l-full w-9 h-9 border-slate-200 plusBtn text-slate-500 dark:text-zink-200 hover:bg-yellow-500 dark:hover:bg-yellow-500 hover:text-yellow-50 dark:hover:text-yellow-50 hover:border-yellow-500 dark:hover:border-yellow-500 focus:bg-yellow-500 dark:focus:bg-yellow-500 focus:border-yellow-500 dark:focus:border-yellow-500 focus:text-yellow-50 dark:focus:text-yellow-50"><i
                                data-lucide="plus" class="inline-block w-4 h-4"></i></button>
                    </div>
                    <div class="inline-flex text-center input-step">
                        <button type="button"
                        ...
                        <input type="number"
                            ...
                            value="45" min="0" max="100" readonly>
                        <button type="button"
                            class="transition-all duration-200 ease-linear bg-white border dark:bg-zink-700 dark:border-zink-500 ltr:rounded-r-full rtl:rounded-l-full w-9 h-9 border-slate-200 plusBtn text-slate-500 dark:text-zink-200 hover:bg-red-500 dark:hover:bg-red-500 hover:text-red-50 dark:hover:text-red-50 hover:border-red-500 dark:hover:border-red-500 focus:bg-red-500 dark:focus:bg-red-500 focus:border-red-500 dark:focus:border-red-500 focus:text-red-50 dark:focus:text-red-50"><i
                                data-lucide="plus" class="inline-block w-4 h-4"></i></button>
                    </div>
                    <div class="inline-flex text-center input-step">
                        <button type="button"
                        ...
                        <input type="number"
                            ...
                            value="34" min="0" max="100" readonly>
                        <button type="button"
                            class="transition-all duration-200 ease-linear bg-white border dark:bg-zink-700 dark:border-zink-500 ltr:rounded-r-full rtl:rounded-l-full w-9 h-9 border-slate-200 plusBtn text-slate-500 dark:text-zink-200 hover:bg-purple-500 dark:hover:bg-purple-500 hover:text-purple-50 dark:hover:text-purple-50 hover:border-purple-500 dark:hover:border-purple-500 focus:bg-purple-500 dark:focus:bg-purple-500 focus:border-purple-500 dark:focus:border-purple-500 focus:text-purple-50 dark:focus:text-purple-50"><i
                                data-lucide="plus" class="inline-block w-4 h-4"></i></button>
                    </div>
                    <div class="inline-flex text-center input-step">
                        <button type="button"
                        ...
                        <input type="number"
                            ...
                            value="55" min="0" max="100" readonly>
                        <button type="button"
                            class="transition-all duration-200 ease-linear bg-white border dark:bg-zink-700 dark:border-zink-500 ltr:rounded-r-full rtl:rounded-l-full w-9 h-9 border-slate-200 plusBtn text-slate-500 dark:text-zink-200 hover:bg-slate-500 dark:hover:bg-zink-500 hover:text-slate-50 dark:hover:text-zink-50 hover:border-slate-500 dark:hover:border-zink-500 focus:bg-slate-500 dark:focus:bg-zink-500 focus:border-slate-500 dark:focus:border-zink-500 focus:text-slate-50 dark:focus:text-zink-50"><i
                                data-lucide="plus" class="inline-block w-4 h-4"></i></button>
                    </div>
                </div>
            </div>
