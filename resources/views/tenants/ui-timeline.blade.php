    ...
    <div class="grid grid-cols-1 gap-x-4 xl:grid-cols-3">
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <div
                        class="relative ltr:pl-6 rtl:pr-6 before:absolute ltr:before:border-l ltr:before:left-[.22rem] rtl:before:border-r before:border-slate-200 rtl:before:right-[.22rem] before:top-1.5 before:-bottom-1.5 after:absolute after:w-2 after:h-2 after:bg-custom-500 after:rounded-full ltr:after:left-0 rtl:after:right-0 after:top-1.5 pb-4 dark:before:border-zink-500">
                    ...
                    <div
                        class="relative ltr:pl-6 rtl:pr-6 after:absolute after:w-2 after:h-2 after:bg-custom-500 after:rounded-full ltr:after:left-0 rtl:after:right-0 after:top-1.5">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <div
                        class="relative ltr:pl-6 rtl:pr-6 before:absolute ltr:before:border-l ltr:before:left-[.22rem] rtl:before:border-r before:border-slate-200 rtl:before:right-[.22rem] before:top-1.5 before:-bottom-1.5 after:absolute after:w-2 after:h-2 after:bg-custom-500 after:rounded-sm ltr:after:left-0 rtl:after:right-0 after:top-1.5 pb-4 dark:before:border-zink-500">
                        <h6 class="mb-4 text-15">Invitation Sent</h6>
                    ...
                    <div
                        class="relative ltr:pl-6 rtl:pr-6 after:absolute after:w-2 after:h-2 after:bg-custom-500 after:rounded-sm ltr:after:left-0 rtl:after:right-0 after:top-1.5">
                        <h6 class="mb-4 text-15">Interview Done</h6>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div>
                    <div
                        class="relative ltr:pl-6 rtl:pr-6 before:absolute ltr:before:border-l ltr:before:left-[.22rem] rtl:before:border-r before:border-slate-200 rtl:before:right-[.22rem] before:top-1.5 before:-bottom-1.5 after:absolute after:w-2 after:h-2 after:bg-white after:border after:rounded-full ltr:after:left-0 rtl:after:right-0 after:top-1.5 pb-4 dark:after:bg-zink-700 dark:after:border-zink-500 dark:before:border-zink-500">
                        <h6 class="mb-4 text-15">Invitation Sent</h6>
                        <p class="mb-2 text-slate-500 dark:text-zink-200">No candidate reply</p>
                        <p class="text-sm text-slate-500 dark:text-zink-200">02 Aug, 2023</p>
                    </div>
                    ...
                    <div
                        class="relative ltr:pl-6 rtl:pr-6 after:absolute after:w-2 after:h-2 after:bg-white after:border-slate-200 after:border after:rounded-full ltr:after:left-0 rtl:after:right-0 after:top-1.5 dark:after:bg-zink-700 dark:after:border-zink-500">
                        <h6 class="mb-4 text-15">Interview Done</h6>
                    </div>
                </div>
            </div>
                    ...
                    <div
                        ...
                        <div class="relative flex gap-2">
                            <img src="{{ URL::asset('build/images/users/avatar-1.png') }}" alt=""
                                class="w-8 h-8 p-0.5 bg-white border rounded-full shrink-0 border-slate-200 dark:border-zink-500 dark:bg-zink-700">
                            <div>
            ...
            <div class="card-body">
                ...
                <div>
                    <div
                        ...
                        <div class="relative flex gap-2">
                            <div
                                class="w-8 h-8 p-0.5 bg-white text-custom-500 flex items-center justify-center border rounded-full shrink-0 border-slate-200 dark:border-zink-500 dark:bg-zink-700">
                                <i data-lucide="bar-chart-horizontal-big" class="w-4 h-4"></i>
                            </div>
                            <div>
                                <h6 class="mb-1">Purchased by James Price</h6>
                                <p class="mb-2 text-slate-500 dark:text-zink-200">Product noise evolve smartwatch</p>
                    ...
                    <div
                        ...
                        <div class="relative flex gap-2">
                            <div
                                class="w-8 h-8 p-0.5 bg-white text-red-500 flex items-center justify-center border rounded-full shrink-0 border-slate-200 dark:border-zink-500 dark:bg-zink-700">
                    ...
                    <div
                        ...
                        <div class="relative flex gap-2">
                            <div
                                class="w-8 h-8 p-0.5 bg-white text-green-500 flex items-center justify-center border rounded-full shrink-0 border-slate-200 dark:border-zink-500 dark:bg-zink-700">
                    ...
                    <div class="relative">
                        <div class="relative flex gap-2">
                            <div
                                class="w-8 h-8 p-0.5 bg-white text-purple-500 flex items-center justify-center border rounded-full shrink-0 border-slate-200 dark:border-zink-500 dark:bg-zink-700">
