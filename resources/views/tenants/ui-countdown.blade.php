            ...
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
                    <div class="px-3 py-6 text-center border rounded-md dark:border-zink-500 border-slate-200">
                        <div
                            class="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-md text-15 bg-custom-50 dark:bg-custom-500/20">
                    ...
                    <div class="px-3 py-6 text-center border rounded-md dark:border-zink-500 border-slate-200">
                        <div
                            class="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-md text-15 bg-red-50 dark:bg-red-500/20">
                    ...
                    <div class="px-3 py-6 text-center border rounded-md dark:border-zink-500 border-slate-200">
                        <div
                            class="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-md text-15 bg-green-50 dark:bg-green-500/20">
                    ...
                    <div class="px-3 py-6 text-center border rounded-md dark:border-zink-500 border-slate-200">
                        <div
                            class="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-md text-15 bg-sky-50 dark:bg-sky-500/20">
            ...
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
                    <div class="px-3 py-6 text-center border rounded-md border-custom-200 dark:border-zink-500">
                        <div
                            class="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-md text-15 bg-custom-50 dark:bg-custom-400/20">
                    ...
                    <div
                        ...
                        <div
                            class="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-md bg-red-50 text-15 dark:bg-red-400/20">
                            <i data-lucide="download" class="text-red-500 fill-red-200 dark:fill-red-500/30"></i></div>
                    ...
                    <div
                        ...
                        <div
                            class="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-md bg-green-50 text-15 dark:bg-green-400/20">
                    ...
                    <div
                        ...
                        <div
                            class="flex items-center justify-center w-12 h-12 mx-auto mb-4 rounded-md bg-white/90 text-15 dark:bg-sky-400/20">
