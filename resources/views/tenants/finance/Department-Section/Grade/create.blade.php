@if (session('creating'))
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var modal = document.getElementById('AddGrade');
            modal.classList.remove('hidden');
        });
    </script>
@endif

<div id="AddGrade" modal-center class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 ">
    <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
        <div class="flex items-center justify-between p-4 border-b dark:border-zink-500">
            <h5 class="text-16">Add Grade</h5>
            <button data-modal-close="AddGrade"
        ...
        <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
            <form action="{{route('grades.store')}}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        ...
                        <div class="xl:col-span-12">
                            ...
                            class="form-input
                                ...
                                @endif" value="{{ old('name') }}" placeholder="Grade Name">
                                @if($errors->has('name') && session('creating'))
                ...
                <div class="flex justify-end gap-2 mt-4">
                    <button type="reset" data-modal-close="AddGrade"
