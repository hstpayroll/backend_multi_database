@if (($errors->has('code') || $errors->has('name')) && @isset($operation ) && $operation == 'store')
    <script>
...
@endif
    ...
    <div id="addCurrency" modal-center
        class="hidden fixed flex flex-col transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4">
        <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
            <div class="flex items-center justify-between p-4 border-b dark:border-zink-500">
                <h5 class="text-16">Add Currency</h5>
                <button data-modal-close="addCurrency"
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form action="{{route('currencies.store')}}" method="POST">
                    ...
                    <div class="flex justify-end gap-2 mt-4">
                        <button type="reset" data-modal-close="addCurrency"
