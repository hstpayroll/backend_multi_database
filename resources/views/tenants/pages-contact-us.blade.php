    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2 xl:grid-cols-4">
        <div class="card">
            <div class="!px-6 card-body flex flex-col h-full">
                <div
                    class="flex items-center justify-center w-16 h-16 mx-auto text-xl bg-white rounded-full shadow dark:bg-zink-600 -mt-14">
                ...
                <div class="mt-auto text-center">
                    <a href="#!"
                        ...
                        Website <i data-lucide="move-right"
                            class="inline-block w-4 h-4 ltr:ml-1 rtl:mr-1 rtl:rotate-180"></i></a>
                </div>
            </div>
        </div><!--end card-->
        <div class="card">
                    ...
                    <div class="flex flex-col h-full card-body">
                        ...
                        <div class="mt-auto">
                            <ul class="flex flex-wrap items-center justify-center gap-2">
                                <li>
                                    <a href="#!"
                                        class="flex items-center justify-center w-10 h-10 transition-all duration-200 ease-linear rounded-md bg-custom-800/50 text-custom-300 hover:text-white dark:bg-custom-900/50">
