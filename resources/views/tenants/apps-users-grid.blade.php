...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
        <div class="card">
            <div class="card-body">
                <div
                    class="relative flex items-center justify-center w-16 h-16 mx-auto text-lg rounded-full bg-slate-100 dark:bg-zink-600">
                    <img src="{{ URL::asset('build/images/users/avatar-1.png') }}" alt=""
                        class="w-16 h-16 rounded-full">
                    <span
                        class="absolute w-3 h-3 bg-green-400 border-2 border-white rounded-full dark:border-zink-700 bottom-1 ltr:right-1 rtl:left-1"></span>
                </div>
                ...
                <div class="flex gap-2 mt-5">
                    <a href="{{ url('apps-chat') }}"
                        class="bg-white text-custom-500 btn border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:bg-zink-700 dark:hover:bg-custom-500 dark:ring-custom-400/20 dark:focus:bg-custom-500 grow"><i
                            data-lucide="messages-square" class="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1"></i> <span
                            class="align-middle">Send Message</span></a>
                    <div class="relative dropdown">
                        <button type="button" id="userGridDropdown12" data-bs-toggle="dropdown"
                            class="dropdown-toggle flex items-center justify-center w-[37.5px] h-[37.5px] p-0 text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><i
            ...
            <div class="card-body">
                <div
                    ...
                    <img src="{{ URL::asset('build/images/users/avatar-4.png') }}" alt=""
                        class="w-16 h-16 rounded-full">
                    <span
                        class="absolute w-3 h-3 bg-red-400 border-2 border-white rounded-full dark:border-zink-500 bottom-1 right-1"></span>
                </div>
                <div class="mt-4 text-center">
