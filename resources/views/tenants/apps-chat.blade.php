                        ...
                        <ul class="flex items-center gap-2 my-auto text-center xl:mb-0 xl:mt-auto xl:pt-4 xl:flex-col">
                            <li>
                                <a href="{{ url('pages-account-settings') }}"
                                    class="inline-flex items-center justify-center w-12 h-12 transition-all duration-200 ease-linear rounded-md group/item"><i
                            ...
                            <li class="hidden md:block">
                                <div class="relative dropdown">
                                    <a href="#!" type="button"
                                        class="inline-flex items-center justify-center w-12 h-12 transition-all duration-200 ease-linear bg-pink-100 rounded-md group/item dropdown-toggle dark:bg-pink-500/20"
                            ...
                            <div class="block tab-pane" id="mainChatList">
                                <div class="card-body">
                                    <div class="flex items-center gap-3">
                                        <button
                                            class="inline-flex items-center justify-center w-8 h-8 transition-all duration-200 ease-linear rounded-md shrink-0 bg-slate-100 text-slate-500 dark:bg-zink-600 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500"><i
                                                data-lucide="chevrons-left" class="w-4 h-4 mx-auto"></i></button>
                                    ...
                                    <ul class="flex flex-col gap-1" id="chatList">
                                        ...
                                        <li>
                                            <a href="#!"
                                                ...
                                                <div
                                                    class="relative flex items-center justify-center font-semibold rounded-full text-slate-500 dark:text-zink-200 w-9 h-9 bg-slate-100 dark:bg-zink-600">
                                    ...
                                    <ul class="flex flex-col gap-1">
                                        <li>
                                            <a href="#!"
                                                ...
                                                <div
                                                    class="relative flex items-center justify-center font-semibold rounded-full text-slate-500 w-7 h-7 dark:text-zink-200 shrink-0">
                            ...
                            <div class="hidden tab-pane" id="profile">
                                <div data-simplebar class="max-h-[calc(100vh_-_250px)] xl:max-h-full card-body">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <button
                                            class="inline-flex items-center justify-center w-8 h-8 transition-all duration-200 ease-linear rounded-md shrink-0 bg-slate-100 text-slate-500 hover:text-red-500 dark:bg-zink-600 dark:text-zink-200 dark:hover:text-red-500"><i
                                                data-lucide="x" class="w-4 h-4 mx-auto "></i></button>
                                    </div>
                                    <div class="text-center">
                                        <div class="w-20 h-20 mx-auto mt-8 bg-pink-100 rounded-full dark:bg-pink-500/20">
                                            <img src="{{ URL::asset('build/images/users/avatar-1.png') }}" alt=""
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <h6 class="mb-3 font-medium"><i data-lucide="phone"
                                                class="inline-block w-4 h-4 mr-1 text-slate-500 dark:text-zink-200"></i>
                                ...
                                <div data-simplebar class="max-h-[calc(100vh_-_380px)] xl:max-h-[calc(100vh_-_300px)]">
                                    <div class="flex flex-col gap-3">
                                        <a href="#!"
                                            ...
                                            <div
                                                class="flex items-center justify-center text-sm font-semibold rounded-md w-9 h-9 bg-slate-100 text-slate-500 dark:bg-zink-600 dark:text-zink-200 shrink-0">
                    ...
                    <div class="card-body">
                        <div class="flex items-center gap-3">
                            ...
                            <a href="#!" data-drawer-target="drawerEnd"
                                ...
                                <div class="w-10 h-10 rounded-full bg-slate-100 dark:bg-zink-600">
                            ...
                            <ul class="flex items-center">
                                ...
                                <li class="hidden md:block">
                                    <a href="#!" data-drawer-target="drawerEnd"
                                        class="inline-flex items-center justify-center w-10 h-10 transition-all duration-200 ease-linear rounded-md group/item">
                            ...
                            <ul class="flex flex-col gap-5 list-none card-body">
                                <li class="flex chat-message group/item [&.right]:justify-end">
                                    <div class="flex gap-3">
                                        <a href="#!"
                                            class="flex items-center self-end justify-center text-sm font-semibold rounded-full w-9 h-9 bg-slate-100 text-slate-500 dark:bg-zink-600 dark:text-zink-200 shrink-0 group-[.right]/item:order-3">
                                            <img src="{{ URL::asset('build/images/users/avatar-7.png') }}" alt=""
                ...
                <div class="relative">
                    <div data-simplebar class="h-[calc(100vh_-_320px)] xl:h-[calc(100vh_-_250px)]">
                        <div
                            ...
                            <div
                                class="relative flex items-center justify-center w-8 h-8 font-semibold rounded-full text-slate-500 bg-slate-100 dark:text-zink-200 dark:bg-zink-600">
                        ...
                        <div class="flex gap-3 card-body bg-slate-50 dark:bg-zink-600">
                            <div
                                class="flex items-center justify-center w-8 h-8 font-semibold rounded-full text-slate-500 bg-slate-100 shrink-0 dark:text-zink-200 dark:bg-zink-600">
                        ...
                        <div
                            ...
                            <div
                                class="relative flex items-center justify-center w-8 h-8 font-semibold rounded-full text-slate-500 bg-slate-100">
                                <img src="{{ URL::asset('build/images/users/user-2.jpg') }}" alt=""
                                    class="h-8 rounded-full">
                            </div>
        ...
        <div id="drawerEnd" drawer-end
            ...
            <div class="h-full p-4 overflow-y-auto">
                <div>
                    ...
                    <div class="text-center">
                        <div class="w-20 h-20 mx-auto mt-8 rounded-full bg-slate-100 dark:bg-zink-600">
                            <img src="{{ URL::asset('build/images/users/avatar-7.png') }}" alt=""
                                class="h-20 rounded-full">
                        </div>
                        <h5 class="mt-4 text-16">William Heineman</h5>
                    ...
                    <div class="mt-5">
                        <p class="mb-4 text-slate-500 dark:text-zink-200">Personal Information</p>
                        <h6 class="mb-3 font-medium"><i data-lucide="phone"
                                class="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1 text-slate-500 dark:text-zink-200"></i>
                            <span class="align-middle">+(103) 1234 567 8954</span>
                        </h6>
                        <h6 class="mb-3 font-medium"><i data-lucide="map-pin"
                                class="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1 text-slate-500 dark:text-zink-200"></i>
        ...
        <div id="addContactModal" modal-center
            ...
            <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600 flex flex-col h-full">
                ...
                <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                    <form action="#!">
                        <div
                            class="relative w-24 h-24 mx-auto mb-4 rounded-full shadow-md bg-slate-100 profile-user dark:bg-zink-500">
                            ...
                            <div
                                class="absolute bottom-0 right-0 flex items-center justify-center w-8 h-8 rounded-full profile-photo-edit">
                                ...
                                <label for="profile-img-file-input"
                                    ...
                                    <i data-lucide="image-plus"
                                        class="w-4 h-4 text-slate-500 fill-slate-200 dark:text-zink-200 dark:fill-zink-500"></i>
                                </label>
                            </div>
                        </div>
                        <div class="mb-3">
        ...
        <div id="callModal" modal-center
            ...
            <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600 flex flex-col h-full">
                <div class="max-h-[calc(theme('height.screen')_-_180px)] p-8">
                    <div class="text-center">
                        <div class="w-20 h-20 mx-auto rounded-full bg-slate-100 dark:bg-zink-500">
                            <img src="{{ URL::asset('build/images/users/avatar-7.png') }}" alt=""
                                class="h-20 rounded-full">
                        </div>
                    ...
                    <div class="flex items-center justify-center gap-3 mt-6">
                        <a href="#!"
                            class="flex items-center justify-center w-12 h-12 p-0 text-white bg-green-500 border-green-500 rounded-full btn hover:text-white hover:bg-green-600 hover:border-green-600 focus:text-white focus:bg-green-600 focus:border-green-600 focus:ring focus:ring-green-100 active:text-white active:bg-green-600 active:border-green-600 active:ring active:ring-green-100 dark:ring-green-400/10"><i
                                data-lucide="phone-call"></i></a>
                        <a href="#!" data-modal-close="callModal"
                            class="flex items-center justify-center w-12 h-12 text-white bg-red-500 border-red-500 rounded-full btn hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:border-red-600 active:ring active:ring-red-100 dark:ring-red-400/20"><i
