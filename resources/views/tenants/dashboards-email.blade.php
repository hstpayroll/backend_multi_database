                        ...
                        <div class="flex mb-4">
                            <div class="w-36 shrink-0">
                                <p class="mb-6 uppercase text-slate-500 dark:text-zink-200"><i
                                        ...
                                        class="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">Open
                                        Rate</span></p>
                        ...
                        <div class="flex mb-4">
                            <div class="w-36 shrink-0">
                                <p class="mb-6 uppercase text-slate-500 dark:text-zink-200"><i data-lucide="goal"
                                        class="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">Click
                                        Through</span></p>
