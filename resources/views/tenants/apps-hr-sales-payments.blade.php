                        ...
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                <span
                                    ...
                                    <span
                                        class="w-1.5 h-1.5 ltr:mr-1 rtl:ml-1 rounded-full bg-green-500 inline-block"></span>
                                    Paid
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                <span
                                    ...
                                    <span
                                        class="w-1.5 h-1.5 ltr:mr-1 rtl:ml-1 rounded-full bg-yellow-500 inline-block"></span>
                                    Pending
                                </span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                <span
                                    ...
                                    <span class="w-1.5 h-1.5 ltr:mr-1 rtl:ml-1 rounded-full bg-red-500 inline-block"></span>
                                    Failed
                                </span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                <span
                                    class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-red-100 border-transparent text-red-500 dark:bg-red-500/20 dark:border-transparent">
                                    <span
                                        class="w-1.5 h-1.5 ltr:mr-1 rtl:ml-1 rounded-full bg-red-500 inline-block"></span>
                                    Failed
                                </span>
                            </td>
                        </tr>
