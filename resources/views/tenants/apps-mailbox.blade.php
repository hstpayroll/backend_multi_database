            ...
            <div class="card-body">
                <button type="button" data-modal-target="addEmailModal"
                    class="w-full text-white bg-red-500 border-red-500 btn hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:border-red-600 active:ring active:ring-red-100 dark:ring-custom-400/20"><i
                        data-lucide="plus" class="inline-block w-4 h-4 mr-1"></i> <span class="align-middle">Compose
                        Email</span></button>
                <ul class="mt-4">
                    <li>
                        <a href="#!"
                            class="transition-all duration-300 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 inline-block py-2 [&.active]:text-custom-500 dark:[&.active]:text-custom-500"><i
                                data-lucide="inbox" class="inline-block w-4 h-4 align-middle rtl:ml-2 ltr:mr-2"></i> <span
                                class="align-middle">Inbox</span></a>
                    </li>
                    <li>
                        <a href="#!"
                            class="transition-all duration-300 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 inline-block py-2 [&.active]:text-custom-500 dark:[&.active]:text-custom-500"><i
                                data-lucide="star" class="inline-block w-4 h-4 align-middle rtl:ml-2 ltr:mr-2"></i> <span
                                class="align-middle">Starred</span></a>
                    </li>
                    <li>
                        <a href="#!"
                            class="transition-all duration-300 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 inline-block py-2 [&.active]:text-custom-500 dark:[&.active]:text-custom-500"><i
                                data-lucide="pen-square" class="inline-block w-4 h-4 align-middle rtl:ml-2 ltr:mr-2"></i>
                            <span class="align-middle">Draft</span></a>
                    </li>
                    <li>
                        <a href="#!"
                            class="transition-all duration-300 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 inline-block py-2 [&.active]:text-custom-500 dark:[&.active]:text-custom-500"><i
                                data-lucide="step-forward" class="inline-block w-4 h-4 align-middle rtl:ml-2 ltr:mr-2"></i>
                            <span class="align-middle">Important</span></a>
                    </li>
                    <li>
                        <a href="#!"
                            class="transition-all duration-300 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 inline-block py-2 [&.active]:text-custom-500 dark:[&.active]:text-custom-500"><i
                                data-lucide="alert-octagon" class="inline-block w-4 h-4 align-middle rtl:ml-2 ltr:mr-2"></i>
                            <span class="align-middle">Spam</span></a>
                    </li>
                    <li>
                        <a href="#!"
                            class="transition-all duration-300 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 inline-block py-2 [&.active]:text-custom-500 dark:[&.active]:text-custom-500"><i
                                data-lucide="user-circle" class="inline-block w-4 h-4 align-middle rtl:ml-2 ltr:mr-2"></i>
                            <span class="align-middle">Contacts</span></a>
                    </li>
                    <li>
                        <a href="#!"
                            class="transition-all duration-300 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 inline-block py-2 [&.active]:text-custom-500 dark:[&.active]:text-custom-500"><i
                                data-lucide="trash-2" class="inline-block w-4 h-4 align-middle rtl:ml-2 ltr:mr-2"></i> <span
                    ...
                    <li>
                        <a href="#!"
                            class="transition-all duration-300 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 inline-block py-2 [&.active]:text-custom-500 dark:[&.active]:text-custom-500"><i
                                data-lucide="radio-tower" class="inline-block w-4 h-4 align-middle rtl:ml-2 ltr:mr-2"></i>
                            <span class="align-middle">Social</span></a>
                    </li>
                    <li>
                        <a href="#!"
                            class="transition-all duration-300 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 inline-block py-2 [&.active]:text-custom-500 dark:[&.active]:text-custom-500"><i
                                data-lucide="squirrel" class="inline-block w-4 h-4 align-middle rtl:ml-2 ltr:mr-2"></i>
                            <span class="align-middle">Updates</span></a>
                    </li>
                    <li>
                        <a href="#!"
                            class="transition-all duration-300 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 inline-block py-2 [&.active]:text-custom-500 dark:[&.active]:text-custom-500"><i
                                data-lucide="file-text" class="inline-block w-4 h-4 align-middle rtl:ml-2 ltr:mr-2"></i>
                            <span class="align-middle">Forums</span></a>
                    </li>
                    <li>
                        <a href="#!"
                            class="transition-all duration-300 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 inline-block py-2 [&.active]:text-custom-500 dark:[&.active]:text-custom-500"><i
                                data-lucide="tag" class="inline-block w-4 h-4 align-middle rtl:ml-2 ltr:mr-2"></i> <span
                    ...
                    <li>
                        <a href="#!"
                            class="transition-all duration-300 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 inline-block py-2 [&.active]:text-custom-500 dark:[&.active]:text-custom-500"><i
                                ...
                                class="inline-block w-4 h-4 text-red-500 align-middle rtl:ml-2 ltr:mr-2"></i> <span
                    ...
                    <li>
                        <a href="#!"
                            class="transition-all duration-300 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 inline-block py-2 [&.active]:text-custom-500 dark:[&.active]:text-custom-500"><i
                                data-lucide="circle-dot"
                                class="inline-block w-4 h-4 text-purple-500 align-middle rtl:ml-2 ltr:mr-2"></i> <span
                    ...
                    <li>
                        <a href="#!"
                            class="transition-all duration-300 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500 inline-block py-2 [&.active]:text-custom-500 dark:[&.active]:text-custom-500"><i
                                data-lucide="circle-dot"
                                class="inline-block w-4 h-4 align-middle rtl:ml-2 ltr:mr-2 text-sky-500"></i> <span
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="flex items-center gap-2" id="email-topbar-actions">
                                        <input id="checkboxAll"
                                            class="form-check-input w-4 h-4 cursor-pointer bg-white border border-slate-200 checked:bg-none dark:bg-zink-700 dark:border-zink-500 rounded-sm appearance-none arrow-none relative after:absolute after:content-['\eb7b'] after:top-0 after:left-0 after:font-remix after:leading-none after:opacity-0 checked:after:opacity-100 after:text-custom-500 checked:border-custom-500 dark:after:text-custom-500 dark:checked:border-custom-800"
                                            type="checkbox">
                                    </div>
                                    <a href="#!"
                                        class="flex items-center justify-center w-6 h-6 transition-all duration-200 ease-linear text-slate-500 dark:text-zink-200 hover:text-slate-600 dark:hover:text-zink-50"><i
                                            data-lucide="refresh-cw" class="w-4 h-4"></i></a>
                                </div>
                                <div class="flex items-center gap-3 ltr:pl-2 rtl:pr-2">
                                    <a href="#!"
                                        class="flex items-center justify-center w-6 h-6 transition-all duration-200 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500"><i
                                            data-lucide="archive-restore" class="w-4 h-4"></i></a>
                                    <a href="#!"
                                        class="flex items-center justify-center w-6 h-6 transition-all duration-200 ease-linear text-slate-500 dark:text-zink-200 hover:text-orange-500 dark:hover:text-orange-500"><i
                                            data-lucide="alert-octagon" class="w-4 h-4"></i></a>
                                    <a href="#!"
                                        class="flex items-center justify-center w-6 h-6 transition-all duration-200 ease-linear text-slate-500 dark:text-zink-200 hover:text-red-500 dark:hover:text-red-500"
                                        data-modal-target="deleteModal"><i data-lucide="trash-2" class="w-4 h-4"></i></a>
                                </div>
                                <div class="flex items-center gap-3 ltr:pl-2 rtl:pr-2">
                                    <a href="#!"
                                        class="flex items-center justify-center w-6 h-6 transition-all duration-200 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500"
                                        id="mark-all-read"><i data-lucide="mail" class="w-4 h-4"></i></a>
                                    <a href="#!"
                                        class="flex items-center justify-center w-6 h-6 transition-all duration-200 ease-linear text-slate-500 dark:text-zink-200 hover:text-green-500 dark:hover:text-green-500"><i
                                            data-lucide="tag" class="w-4 h-4"></i></a>
                                    <a href="#!"
                                        class="flex items-center justify-center w-6 h-6 transition-all duration-200 ease-linear text-slate-500 dark:text-zink-200 hover:text-sky-500 dark:hover:text-sky-500"><i
                                            data-lucide="clock" class="w-4 h-4"></i></a>
                                </div>
                                            ...
                                            <div class="flex items-center gap-3 ltr:pl-2 rtl:pr-2 checkbox-wrapper-mail">
                                                ...
                                                <a href="#!"
                                                    class="transition-all duration-200 ease-linear text-slate-500 hover:text-yellow-500 dark:text-zink-200 dark:hover:text-yellow-500"><i
                                                        data-lucide="star" class="w-4 h-4"></i></a>
                                                <a href="#!"
                                                    class="transition-all duration-200 ease-linear text-slate-500 hover:text-yellow-500 dark:text-zink-200 dark:hover:text-yellow-500"><i
                                                        data-lucide="step-forward" class="w-4 h-4"></i></a>
                                            </div>
                                        </td>
                                        <td
                ...
                <div class="card-body">
                    <div class="flex gap-2">
                        ...
                        <div class="flex gap-3 shrink-0">
                            ...
                            <a href="#!"
                                class="flex items-center justify-center w-6 h-6 transition-all duration-200 ease-linear text-slate-500 dark:text-zink-200 hover:text-sky-500 dark:hover:text-sky-500"><i
                                    data-lucide="printer" class="w-4 h-4"></i></a>
                            <a href="#!"
                                class="flex items-center justify-center w-6 h-6 transition-all duration-200 ease-linear text-slate-500 dark:text-zink-200 hover:text-yellow-500 dark:hover:text-yellow-500"><i
                                    data-lucide="star" class="w-4 h-4"></i></a>
                            <a href="#!"
                                class="flex items-center justify-center w-6 h-6 transition-all duration-200 ease-linear text-slate-500 dark:text-zink-200 hover:text-red-500 dark:hover:text-red-500"><i
                ...
                <div class="xl:max-h-[calc(100vh_-_385px)]" data-simplebar>
                    <div class="card-body !pt-0">
                        <div class="flex gap-3 mt-3 first:mt-0">
                            <div
                                class="relative flex items-center justify-center font-semibold rounded-full text-slate-500 w-9 h-9 bg-slate-100 shrink-0 dark:text-zink-200 dark:bg-zink-600">
                        ...
                        <div class="flex gap-3 mt-3 first:mt-0">
                            <div
                                class="relative flex items-center justify-center font-semibold bg-pink-100 rounded-full text-slate-500 w-9 h-9 shrink-0 dark:bg-pink-500/20 dark:text-zink-200">
