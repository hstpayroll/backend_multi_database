                    ...
                    <div class="card-body">
                        ...
                        <div class="flex gap-2 mt-4 shrink-0">
                            <a href="{{ url('apps-ecommerce-cart') }}" type="button"
                                class="w-full bg-white border-dashed text-custom-500 btn border-custom-500 hover:text-custom-500 hover:bg-custom-50 hover:border-custom-600 focus:text-custom-600 focus:bg-custom-50 focus:border-custom-600 active:text-custom-600 active:bg-custom-50 active:border-custom-600 dark:bg-zink-700 dark:ring-custom-400/20 dark:hover:bg-custom-800/20 dark:focus:bg-custom-800/20 dark:active:bg-custom-800/20"><i
                                    ...
                                    class="inline-block w-3 h-3 align-middle ltr:mr-1 rtl:ml-1"></i> <span
                        ...
                        <div class="flex items-center gap-3 mt-3 justify-evenly">
                            <a href="#!" class="transition-all duration-300 ease-linear hover:text-custom-500"><i
                                    data-lucide="repeat" class="inline-block w-3 h-3 align-middle ltr:mr-1 rtl:ml-1"></i>
                            ...
                            <a href="#!" data-modal-target="shareModal"
                                class="transition-all duration-300 ease-linear hover:text-custom-500"><i
                                    data-lucide="share-2" class="inline-block w-3 h-3 align-middle ltr:mr-1 rtl:ml-1"></i>
                ...
                <div class="card">
                    <div class="border-b card-body border-slate-200 dark:border-zink-500">
                        <div class="flex">
                            ...
                            <div class="shrink-0">
                                <i data-lucide="star" class="inline-block w-4 h-4 text-yellow-500 ltr:mr-1 rtl:ml-1"></i>
                    ...
                    <div class="card-body">
                        <div class="flex">
                            <h6 class="grow text-15"><i data-lucide="map-pin"
                                    class="inline-block w-4 h-4 text-orange-500 ltr:mr-1 rtl:ml-1"></i> <span
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <input id="color1"
                            class="w-5 h-5 border rounded-sm appearance-none cursor-pointer border-custom-500 bg-custom-500 checked:bg-custom-500 checked:border-custom-500 disabled:opacity-75 disabled:cursor-default"
                            type="radio" name="SelectColor" value="" disabled>
                        <input id="color2"
                            class="w-5 h-5 bg-red-300 border border-red-300 rounded-sm appearance-none cursor-pointer checked:bg-red-300 checked:border-red-300 disabled:opacity-75 disabled:cursor-default"
                            type="radio" name="SelectColor" value="">
                        <input id="color3"
                            class="w-5 h-5 bg-green-300 border border-green-300 rounded-sm appearance-none cursor-pointer checked:bg-green-300 checked:border-green-300 disabled:opacity-75 disabled:cursor-default"
                            type="radio" name="SelectColor" value="">
                        <input id="color4"
                            class="w-5 h-5 border rounded-sm appearance-none cursor-pointer border-slate-500 bg-slate-500 checked:bg-slate-500 checked:border-slate-500 disabled:opacity-75 disabled:cursor-default"
                            type="radio" name="SelectColor" value="">
                        <input id="color5"
                            class="w-5 h-5 bg-purple-500 border border-purple-500 rounded-sm appearance-none cursor-pointer checked:bg-purple-500 checked:border-purple-500 disabled:opacity-75 disabled:cursor-default"
                            type="radio" name="SelectColor" value="">
                        <input id="color6"
                            class="w-5 h-5 border rounded-sm appearance-none cursor-pointer bg-sky-500 border-sky-500 checked:bg-sky-500 checked:border-sky-500 disabled:opacity-75 disabled:cursor-default"
                            type="radio" name="SelectColor" value="">
                        <input id="color7"
                            class="w-5 h-5 bg-yellow-500 border border-yellow-500 rounded-sm appearance-none cursor-pointer checked:bg-yellow-500 checked:border-yellow-500 disabled:opacity-75 disabled:cursor-default"
                            type="radio" name="SelectColor" value="">
                        <input id="color7"
                            class="w-5 h-5 bg-green-500 border border-green-500 rounded-sm appearance-none cursor-pointer checked:bg-green-500 checked:border-green-500 disabled:opacity-75 disabled:cursor-default"
                            type="radio" name="SelectColor" value="">
                        <input id="color8"
                            class="w-5 h-5 border rounded-sm appearance-none cursor-pointer bg-slate-800 border-slate-800 checked:bg-slate-800 checked:border-slate-800 disabled:opacity-75 disabled:cursor-default"
                            type="radio" name="SelectColor" value="">
                        <input id="color9"
                            class="w-5 h-5 border rounded-sm appearance-none cursor-pointer bg-slate-200 border-slate-200 checked:bg-slate-200 checked:border-slate-200 disabled:opacity-75 disabled:cursor-default"
                            type="radio" name="SelectColor" value="">
                        <input id="color10"
                            class="w-5 h-5 border rounded-sm appearance-none cursor-pointer bg-emerald-300 border-embg-emerald-300 checked:bg-emerald-300 checked:border-embg-emerald-300 disabled:opacity-75 disabled:cursor-default"
                            type="radio" name="SelectColor" value="">
                    </div>
                    ...
                    <ul class="flex flex-col gap-2">
                        <li><i data-lucide="tag"
                                class="inline-block w-4 h-4 text-green-500 ltr:mr-1 rtl:ml-1 fill-green-200 dark:fill-green-500/20"></i>
                    ...
                    <div class="grid grid-cols-1 gap-5 my-5 xl:grid-cols-3">
                        <div class="flex items-center gap-5 p-4 border rounded-md border-slate-200 dark:border-zink-500">
                            <div class="flex items-center justify-center">
                                <i data-lucide="truck"
                                    class="w-6 h-6 text-slate-500 fill-slate-200 dark:text-zink-200 dark:fill-zink-500"></i>
                            </div>
                            <div>
                                ...
                                <div class="flex items-center gap-3 mt-3">
                                    <a href="#!"
                                        class="text-slate-500 shrink-0 count-button [&.active]:text-green-500 active"><i
                                            data-lucide="thumbs-up" class="inline-block w-3 h-3 ltr:mr-1 rtl:ml-1"></i>
                                        <span class="align-middle count-number">15</span></a>
                                    <a href="#!"
                                        class="text-slate-500 shrink-0 count-button [&.active]:text-red-500 active"><i
                                            data-lucide="thumbs-down" class="inline-block w-3 h-3 ltr:mr-1 rtl:ml-1"></i>
        ...
        <div class="w-screen md:w-[25rem] bg-white shadow rounded-md dark:bg-zink-600">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                ...
                <ul class="flex gap-2 item-center">
                    <li><a href="#!"
                            class="flex items-center justify-center transition-all duration-200 ease-linear rounded-md w-9 h-9 text-slate-500 bg-slate-100 hover:bg-custom-100 hover:text-custom-500 dark:text-zink-200 dark:bg-zink-500 dark:hover:bg-zink-500 dark:hover:text-custom-500"><i
                                data-lucide="facebook" class="w-4 h-4"></i></a></li>
                    <li><a href="#!"
                            class="flex items-center justify-center transition-all duration-200 ease-linear rounded-md w-9 h-9 text-slate-500 bg-slate-100 hover:bg-custom-100 hover:text-custom-500 dark:text-zink-200 dark:bg-zink-500 dark:hover:bg-zink-500 dark:hover:text-custom-500"><i
                                data-lucide="instagram" class="w-4 h-4"></i></a></li>
                    <li><a href="#!"
                            class="flex items-center justify-center transition-all duration-200 ease-linear rounded-md w-9 h-9 text-slate-500 bg-slate-100 hover:bg-custom-100 hover:text-custom-500 dark:text-zink-200 dark:bg-zink-500 dark:hover:bg-zink-500 dark:hover:text-custom-500"><i
                                data-lucide="mail" class="w-4 h-4"></i></a></li>
                    <li><a href="#!"
                            class="flex items-center justify-center transition-all duration-200 ease-linear rounded-md w-9 h-9 text-slate-500 bg-slate-100 hover:bg-custom-100 hover:text-custom-500 dark:text-zink-200 dark:bg-zink-500 dark:hover:bg-zink-500 dark:hover:text-custom-500"><i
                                data-lucide="dribbble" class="w-4 h-4"></i></a></li>
                </ul>
            </div>
        </div>
    </div><!--end share modal-->
