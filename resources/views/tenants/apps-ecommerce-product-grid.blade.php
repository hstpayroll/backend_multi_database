                    ...
                    <div class="mt-4 collapsible">
                        ...
                        <div class="mt-4 collapsible-content">
                            <div class="flex flex-wrap items-center gap-2">
                                <input id="color1"
                                    class="w-5 h-5 border rounded-sm appearance-none cursor-pointer border-custom-500 bg-custom-500 checked:bg-custom-500 checked:border-custom-500"
                                    type="checkbox" value="">
                                <input id="color2"
                                    class="w-5 h-5 bg-red-300 border border-red-300 rounded-sm appearance-none cursor-pointer checked:bg-red-300 checked:border-red-300"
                                    type="checkbox" value="">
                                <input id="color3"
                                    class="w-5 h-5 bg-green-300 border border-green-300 rounded-sm appearance-none cursor-pointer checked:bg-green-300 checked:border-green-300"
                                    type="checkbox" value="">
                                <input id="color4"
                                    class="w-5 h-5 border rounded-sm appearance-none cursor-pointer border-slate-500 bg-slate-500 checked:bg-slate-500 checked:border-slate-500"
                                    type="checkbox" value="">
                                <input id="color5"
                                    class="w-5 h-5 bg-purple-500 border border-purple-500 rounded-sm appearance-none cursor-pointer checked:bg-purple-500 checked:border-purple-500"
                                    type="checkbox" value="">
                                <input id="color6"
                                    class="w-5 h-5 border rounded-sm appearance-none cursor-pointer bg-sky-500 border-sky-500 checked:bg-sky-500 checked:border-sky-500"
                                    type="checkbox" value="">
                                <input id="color7"
                                    class="w-5 h-5 bg-yellow-500 border border-yellow-500 rounded-sm appearance-none cursor-pointer checked:bg-yellow-500 checked:border-yellow-500"
                                    type="checkbox" value="">
                                <input id="color7"
                                    class="w-5 h-5 bg-green-500 border border-green-500 rounded-sm appearance-none cursor-pointer checked:bg-green-500 checked:border-green-500"
                                    type="checkbox" value="">
                                <input id="color8"
                                    class="w-5 h-5 border rounded-sm appearance-none cursor-pointer bg-slate-800 border-slate-800 checked:bg-slate-800 checked:border-slate-800"
                                    type="checkbox" value="">
                                <input id="color9"
                                    class="w-5 h-5 border rounded-sm appearance-none cursor-pointer bg-slate-200 border-slate-200 checked:bg-slate-200 checked:border-slate-200"
                                    type="checkbox" value="">
                                <input id="color10"
                                    class="w-5 h-5 border rounded-sm appearance-none cursor-pointer bg-emerald-300 border-embg-emerald-300 checked:bg-emerald-300 checked:border-embg-emerald-300"
                                    type="checkbox" value="">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <label for="rating5" class="align-middle cursor-pointer">
                                        <i data-lucide="star"
                                            class="inline-block w-4 h-4 ml-1 text-yellow-500 align-middle"></i> <span
                ...
                <span
                    ...
                    to Low <a href="#!"
                        class="transition text-slate-500 dark:text-zink-200 hover:text-slate-600 dark:hover:text-zink-100"><i
                            data-lucide="x" class="w-3 h-3 ltr:ml-1 rtl:mr-1"></i></a></span>
                <span
