                                ...
                                <div class="grid grid-cols-1 gap-3 mb-4 md:grid-cols-3 lg:grid-cols-4">
                                    <div>
                                        <input id="brandingRadio" name="businessType"
                                            class="hidden w-4 h-4 border rounded-full appearance-none peer/business bg-slate-100 border-slate-200 dark:bg-zink-600 dark:border-zink-500 checked:bg-custom-500 dark:checked:bg-custom-500 checked:border-custom-500 dark:checked:border-custom-500"
                                        ...
                                        <label for="brandingRadio"
                                            ...
                                            <i data-lucide="gem"
                                                class="block w-8 h-8 mx-auto mb-3 stroke-1 fill-slate-100 dark:fill-zink-600"></i>
