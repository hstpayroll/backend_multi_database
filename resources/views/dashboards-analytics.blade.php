...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-x-5">
        <div
            ...
            <div class="card-body">
                <i data-lucide="kanban"
                    class="absolute top-0 w-32 h-32 stroke-1 text-green-200/50 dark:text-green-500/20 ltr:-right-10 rtl:-left-10"></i>
                <div class="flex items-center justify-center w-12 h-12 bg-green-500 rounded-md text-15 text-green-50">
        ...
        <div
            ...
            <div class="card-body">
                <i data-lucide="list-filter"
                    class="absolute top-0 w-32 h-32 stroke-1 text-orange-200/50 dark:text-orange-500/20 ltr:-right-10 rtl:-left-10"></i>
                <div class="flex items-center justify-center w-12 h-12 bg-orange-500 rounded-md text-15 text-orange-50">
                    <i data-lucide="cog"></i>
                </div>
                ...
                <div class="flex items-center gap-2 mb-3">
                    ...
                    <div class="relative dropdown shrink-0">
                        ...
                        <button type="button"
                            ...
                            This Yearly <i data-lucide="chevron-down" class="inline-block w-4 h-4 ltr:ml-1 rlt:mr-1"></i>
                        </button>
        ...
        <div
            ...
            <div class="card-body">
                <i data-lucide="list-filter"
                    class="absolute top-0 w-32 h-32 stroke-1 text-sky-200/50 dark:text-sky-500/20 ltr:-right-10 rtl:-left-10"></i>
                <div class="flex items-center justify-center w-12 h-12 rounded-md bg-sky-500 text-15 text-sky-50">
        ...
        <div
            ...
            <div class="card-body">
                <i data-lucide="kanban"
                    class="absolute top-0 w-32 h-32 stroke-1 text-purple-200/50 dark:text-purple-500/20 ltr:-right-10 rtl:-left-10"></i>
                <div class="flex items-center justify-center w-12 h-12 bg-purple-500 rounded-md text-15 text-purple-50">
                    <i data-lucide="users"></i>
                </div>
                    ...
                    <div class="shrink-0">
                        <button type="button"
                            ...
                            View More <i data-lucide="move-right"
                                class="inline-block w-4 h-4 ltr:ml-1 rlt:mr-1 rtl:-rotate-180"></i>
                        </button>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-2 mb-3">
                    <h6 class="text-15 grow">User Device <a href="#!" data-tooltip="default"
                            ...
                            class="inline-block align-middle ltr:ml-1 rtl:mr-1 text-slate-500 dark:text-zink-200"><i
                                data-lucide="info" class="w-4 h-4"></i></a></h6>
                    <div class="relative dropdown shrink-0">
                        <button type="button"
                                ...
                                <td
                                    ...
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-green-100 border-transparent text-green-500 dark:bg-green-500/20 dark:border-transparent"><i
                                            data-lucide="check-circle-2" class="w-3 h-3 ltr:mr-1 rtl:ml-1"></i>
                                        Active</span>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td
                                    ...
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-red-100 border-transparent text-red-500 dark:bg-red-500/20 dark:border-transparent"><i
                                            data-lucide="x-circle" class="w-3 h-3 ltr:mr-1 rtl:ml-1"></i> Unactive</span>
                                </td>
                            </tr>
                            <tr>
                                <td
            ...
            <div class="card-body">
                ...
                <ul class="flex flex-col gap-5">
                    <li class="flex items-center gap-3">
                        <div
                            class="flex items-center justify-center w-8 h-8 text-red-500 bg-red-100 rounded-md dark:bg-red-500/20 shrink-0">
                    ...
                    <li class="flex items-center gap-3">
                        <div
                            class="flex items-center justify-center w-8 h-8 rounded-md text-sky-500 bg-sky-100 dark:bg-sky-500/20 shrink-0">
                    ...
                    <li class="flex items-center gap-3">
                        <div
                            class="flex items-center justify-center w-8 h-8 text-orange-500 bg-orange-100 rounded-md dark:bg-orange-500/20 shrink-0">
                            <i data-lucide="user-x-2" class="w-4 h-4"></i>
                        </div>
                    ...
                    <li class="flex items-center gap-3">
                        <div
                            class="flex items-center justify-center w-8 h-8 text-green-500 bg-green-100 rounded-md dark:bg-green-500/20 shrink-0">
                    ...
                    <li class="flex items-center gap-3">
                        <div
                            class="flex items-center justify-center w-8 h-8 rounded-md text-slate-500 bg-slate-100 dark:bg-zink-600 dark:text-zink-200 shrink-0">
