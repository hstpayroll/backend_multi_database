                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <span
                            ...
                            <a href="#!" class="transition text-custom-400 hover:text-custom-600"><i data-lucide="x"
                                    class="w-3 h-3 ltr:ml-1 rtl:mr-1"></i></a></span>
                        <span
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <span
                            class="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-custom-100 border-transparent text-custom-500 dark:bg-custom-500/20 dark:border-transparent"><i
                                data-lucide="frown" class="w-3 h-3 ltr:mr-1 rtl:ml-1"></i> Custom</span>
                        <span
                            class="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-green-100 border-transparent text-green-500 dark:bg-green-500/20 dark:border-transparent"><i
                                data-lucide="frown" class="w-3 h-3 ltr:mr-1 rtl:ml-1"></i> Green</span>
                        <span
                            class="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-orange-100 border-transparent text-orange-500 dark:bg-orange-500/20 dark:border-transparent"><i
                                data-lucide="frown" class="w-3 h-3 ltr:mr-1 rtl:ml-1"></i> Orange</span>
                        <span
                            class="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-sky-100 border-transparent text-sky-500 dark:bg-sky-500/20 dark:border-transparent"><i
                                data-lucide="frown" class="w-3 h-3 ltr:mr-1 rtl:ml-1"></i> Sky</span>
                        <span
                            class="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-yellow-100 border-transparent text-yellow-500 dark:bg-yellow-500/20 dark:border-transparent"><i
                                data-lucide="frown" class="w-3 h-3 ltr:mr-1 rtl:ml-1"></i> Yellow</span>
                        <span
                            class="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-red-100 border-transparent text-red-500 dark:bg-red-500/20 dark:border-transparent"><i
                                data-lucide="frown" class="w-3 h-3 ltr:mr-1 rtl:ml-1"></i> Red</span>
                        <span
                            class="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-purple-100 border-transparent text-purple-500 dark:bg-purple-500/20 dark:border-transparent"><i
                                data-lucide="frown" class="w-3 h-3 ltr:mr-1 rtl:ml-1"></i> Purple</span>
                        <span
                            class="flex items-center px-2.5 py-0.5 text-xs font-medium rounded border bg-slate-100 border-transparent text-slate-500 dark:bg-slate-500/20 dark:text-zink-200 dark:border-transparent"><i
                                data-lucide="frown" class="w-3 h-3 ltr:mr-1 rtl:ml-1"></i> Slate</span>
                    </div>
                </div>
            </div><!--end card-->
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <span
                            ...
                            <span class="w-1.5 h-1.5 ltr:mr-1 rtl:ml-1 rounded-full inline-block bg-custom-500"></span>
                            Custom
                        </span>
                        <span
                            ...
                            <span class="w-1.5 h-1.5 ltr:mr-1 rtl:ml-1 rounded-full inline-block bg-green-500"></span>
                            Green
                        </span>
                        <span
                            ...
                            <span class="w-1.5 h-1.5 ltr:mr-1 rtl:ml-1 rounded-full inline-block bg-orange-500"></span>
                            Orange
                        </span>
                        <span
                            ...
                            <span class="w-1.5 h-1.5 ltr:mr-1 rtl:ml-1 rounded-full inline-block bg-sky-500"></span> Sky
                        </span>
                        <span
                            ...
                            <span class="w-1.5 h-1.5 ltr:mr-1 rtl:ml-1 rounded-full inline-block bg-yellow-500"></span>
                            Yellow
                        </span>
                        <span
                            ...
                            <span class="w-1.5 h-1.5 ltr:mr-1 rtl:ml-1 rounded-full inline-block bg-red-500"></span> Red
                        </span>
                        <span
                            ...
                            <span class="w-1.5 h-1.5 ltr:mr-1 rtl:ml-1 rounded-full inline-block bg-purple-500"></span>
                            Purple
                        </span>
                        <span
                            ...
                            <span class="w-1.5 h-1.5 ltr:mr-1 rtl:ml-1 rounded-full inline-block bg-slate-500"></span>
                            Slate
                        </span>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 gap-x-5 xl:grid-cols-2">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <span
                            class="flex items-center justify-center w-8 h-8 text-xs font-medium border border-transparent rounded bg-custom-100 text-custom-500 dark:bg-custom-500/20 dark:border-transparent"><i
                                data-lucide="gift" class="w-3 h-3"></i></span>
                        <span
                            class="flex items-center justify-center w-8 h-8 text-xs font-medium text-green-500 bg-green-100 border border-transparent rounded-full dark:bg-green-500/20 dark:border-transparent"><i
                                data-lucide="gift" class="w-3 h-3"></i></span>
                        <span
                            class="flex items-center justify-center w-8 h-8 text-xs font-medium text-orange-500 bg-white border border-transparent rounded dark:bg-orange-500/20 dark:border-transparent"><i
                                data-lucide="gift" class="w-3 h-3"></i></span>
                    </div>
                </div>
            </div><!--end card-->
                ...
                <div class="card-body">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <button type="button"
                            ...
                            Custom Button
                            <span
                                class="flex items-center justify-center w-5 h-5 ltr:ml-2 rtl:mr-2 text-[10px] shrink-0 font-medium border rounded-full bg-custom-400 border-custom-400">15</span>
                        </button>
                        <button type="button"
                            class="flex items-center justify-center w-[37.5px] h-[37.5px] relative p-0 text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">
                            <span
                                class="absolute flex items-center justify-center w-5 h-5 text-[11px] font-medium bg-red-400 border border-red-400 rounded-full ltr:-right-2 rtl:-left-4 -top-2">8</span>
