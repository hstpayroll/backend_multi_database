...
<body class="text-base bg-white text-body font-public dark:text-zink-50 dark:bg-zinc-900">
        ...
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto flex items-center self-center w-full">
            ...
            <div class="flex gap-2">
                <div class="ltr:ml-auto rtl:mr-auto md:hidden navbar-toggale-button">
                    <button type="button" class="flex items-center  justify-center w-[37.5px] h-[37.5px] p-0 text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><i data-lucide="menu"></i></button>
                </div>
                <button type="button" class="text-slate-500 dark:text-zinc-300 hover:text-custom-500 dark:hover:text-custom-500 border-0 btn bg-gradient-to-r w-[36.39px] p-0 flex items-center justify-center"><i data-lucide="shopping-bag" class="inline-block w-4 h-4"></i></button>
                <button type="button" class="text-white border-0 btn bg-gradient-to-r from-custom-500 to-purple-500 hover:text-white hover:from-purple-500 hover:to-custom-500"><span class="align-middle">Sign In</span> <i data-lucide="log-in" class="inline-block w-4 h-4 ltr:ml-1 rtl:mr-1"></i></button>
            </div>
        </div>
    </nav>

    <section class="relative pb-28 xl:pb-36 pt-44 xl:pt-52" id="home">
        <div class="absolute top-0 left-0 w-64 h-64 bg-custom-500 opacity-10 blur-3xl"></div>
        <div class="absolute bottom-0 right-0 w-64 h-64 bg-purple-500/10 blur-3xl"></div>
            ...
            <div class="grid items-center grid-cols-12 gap-5 2xl:grid-cols-12">
                <div class="col-span-12 xl:col-span-5 2xl:col-span-5">
                    ...
                    <div class="flex items-center gap-2" data-aos="fade-right" data-aos-delay="800">
                        <button type="button" class="px-8 py-3 text-white border-0 text-15 btn bg-gradient-to-r from-custom-500 to-purple-500 hover:text-white hover:from-purple-500 hover:to-custom-500">Shop Now <i data-lucide="shopping-cart" class="inline-block w-4 h-4 align-middle rtl:mr-1 ltr:ml-1"></i></button>
                    </div>
                </div>
                <div class="col-span-12 xl:col-span-7 2xl:col-start-8 2xl:col-span-6">
                    <div class="relative mt-10 xl:mt-0">
                        ...
                        <div class="relative" data-aos="zoom-in" data-aos-delay="500">
                            <button data-tooltip="default" data-tooltip-content="$199.99" class="absolute items-center justify-center hidden w-8 h-8 bg-white rounded-full xl:flex bottom-20 text-slate-800 left-20"><i data-lucide="plus"></i></button>
        ...
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-5 mt-12 md:grid-cols-2 xl:grid-cols-4">
                <div class="p-5 rounded-md bg-gradient-to-b from-slate-100 to-white dark:from-zinc-800 dark:to-zinc-900" data-aos="fade-up" data-aos-easing="linear">
                    ...
                    <div class="mt-3">
                        <p class="mb-3"><i data-lucide="star" class="inline-block w-4 h-4 text-yellow-500 align-middle ltr:mr-1 rtl:ml-1"></i> (4.8)</p>
                ...
                <div class="p-5 rounded-md bg-gradient-to-b from-slate-100 to-white dark:from-zinc-800 dark:to-zinc-900" data-aos="fade-up" data-aos-easing="linear">
                    ...
                    <div class="mt-3">
                        <p class="mb-3"><i data-lucide="star" class="inline-block w-4 h-4 text-yellow-500 align-middle ltr:mr-1 rtl:ml-1"></i> (4.4)</p>
                ...
                <div class="p-5 rounded-md bg-gradient-to-b from-slate-100 to-white dark:from-zinc-800 dark:to-zinc-900" data-aos="fade-up" data-aos-easing="linear">
                    ...
                    <div class="mt-3">
                        <p class="mb-3"><i data-lucide="star" class="inline-block w-4 h-4 text-yellow-500 align-middle ltr:mr-1 rtl:ml-1"></i> (4.9)</p>
                ...
                <div class="p-5 rounded-md bg-gradient-to-b from-slate-100 to-white dark:from-zinc-800 dark:to-zinc-900" data-aos="fade-up" data-aos-easing="linear">
                    ...
                    <div class="mt-3">
                        <p class="mb-3"><i data-lucide="star" class="inline-block w-4 h-4 text-yellow-500 align-middle ltr:mr-1 rtl:ml-1"></i> (4.6)</p>
    ...
    <section class="relative py-24 xl:py-32" id="features">
        <div class="absolute top-0 left-0 w-64 h-64 bg-purple-500/10 blur-3xl"></div>
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            <div class="grid items-center grid-cols-1 gap-6 mt-20 lg:grid-cols-12">
                <div class="lg:col-span-5">
                    ...
                    <a href="#!" class="text-custom-500 text-16" data-aos="fade-right" data-aos-delay="600">Shopping Now <i data-lucide="move-right" class="inline-block w-4 h-4 align-middle ltr:ml-1 rtl:mr-1 rtl:rotate-180"></i></a>
                </div><!--end col-->
        ...
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            <div class="grid items-center grid-cols-1 gap-6 mt-20 lg:grid-cols-12">
                ...
                <div class="ml-auto lg:col-span-5 lg:col-start-8">
                    ...
                    <button type="button" class="px-8 py-3 text-white border-0 text-15 btn bg-gradient-to-r from-custom-500 to-purple-500 hover:text-white hover:from-purple-500 hover:to-custom-500" data-aos="fade-left" data-aos-delay="600">Explore Now <i data-lucide="move-right" class="inline-block w-4 h-4 align-middle rtl:mr-1 ltr:ml-1"></i></button>
                </div><!--end col-->
            </div><!--end grid-->
        </div><!--end container-->
    </section><!--end -->
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="p-5 text-center" data-aos="fade-up" data-aos-easing="linear">
                            <div class="w-20 h-20 mx-auto rounded-full bg-custom-500/10">
                                <img src="{{ URL::asset('build/images/users/avatar-2.png') }}" alt="" class="w-20 h-20 rounded-full">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="p-5 text-center" data-aos="fade-up" data-aos-easing="linear">
                            <div class="w-20 h-20 mx-auto rounded-full bg-yellow-500/10">
                                <img src="{{ URL::asset('build/images/users/avatar-4.png') }}" alt="" class="w-20 h-20 rounded-full">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="p-5 text-center" data-aos="fade-up" data-aos-easing="linear">
                            <div class="w-20 h-20 mx-auto rounded-full bg-red-500/10">
                                <img src="{{ URL::asset('build/images/users/avatar-7.png') }}" alt="" class="w-20 h-20 rounded-full">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="swiper-slide">
                            <div class="p-5 text-center" data-aos="fade-up" data-aos-easing="linear">
                                <div class="w-20 h-20 mx-auto rounded-full bg-purple-500/10">
                                    <img src="{{ URL::asset('build/images/users/avatar-9.png') }}" alt="" class="w-20 h-20 rounded-full">
                                </div>
    ...
    <footer class="relative pt-20 pb-12 border-t border-slate-200 dark:border-zinc-800">
        <div class="absolute left-0 w-64 h-64 bg-purple-500 -top-16 opacity-10 blur-3xl"></div>
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            <div class="relative z-10 grid grid-cols-12 gap-5 xl:grid-cols-12">
                <div class="col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-4">
                    ...
                    <ul class="flex items-center gap-3">
                        <li>
                            <a href="#!" class="flex items-center justify-center w-10 h-10 transition-all duration-200 ease-linear border rounded-full text-slate-500 border-slate-200 dark:text-zinc-400 dark:border-zinc-800 hover:text-custom-500 dark:hover:text-custom-500"><i data-lucide="facebook" class="w-4 h-4"></i></a>
                        </li>
                        <li>
                            <a href="#!" class="flex items-center justify-center w-10 h-10 transition-all duration-200 ease-linear border rounded-full text-slate-500 border-slate-200 dark:text-zinc-400 dark:border-zinc-800 hover:text-custom-500 dark:hover:text-custom-500"><i data-lucide="linkedin" class="w-4 h-4"></i></a>
                        </li>
                        <li>
                            <a href="#!" class="flex items-center justify-center w-10 h-10 transition-all duration-200 ease-linear border rounded-full text-slate-500 border-slate-200 dark:text-zinc-400 dark:border-zinc-800 hover:text-custom-500 dark:hover:text-custom-500"><i data-lucide="instagram" class="w-4 h-4"></i></a>
                        </li>
                        <li>
                            <a href="#!" class="flex items-center justify-center w-10 h-10 transition-all duration-200 ease-linear border rounded-full text-slate-500 border-slate-200 dark:text-zinc-400 dark:border-zinc-800 hover:text-custom-500 dark:hover:text-custom-500"><i data-lucide="twitter" class="w-4 h-4"></i></a>
                        </li>
                        <li>
                            <a href="#!" class="flex items-center justify-center w-10 h-10 transition-all duration-200 ease-linear border rounded-full text-slate-500 border-slate-200 dark:text-zinc-400 dark:border-zinc-800 hover:text-custom-500 dark:hover:text-custom-500"><i data-lucide="youtube" class="w-4 h-4"></i></a>
                        </li>
                    </ul>
                </div>
