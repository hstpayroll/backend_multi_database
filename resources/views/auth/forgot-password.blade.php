                ...
                <div class="lg:col-span-5">
                    <div class="!px-12 !py-12 card-body h-full flex flex-col">
                        ...
                        <div class="my-auto">
                            ...
                            @if (session('status'))
                                <div
                                    class="mb-4 font-medium text-sm text-green-600 border border-transparent rounded-md bg-green-50 px-4 py-3">
                                    {{ session('status') }}
                                </div>
                            @endif
                            ...
                            <form method="POST" action="{{ route('password.email') }}">
                                ...
                                <div>
                                    ...
                                    <x-input id="email" type="email" name="email" :value="old('email')" required
                                        autofocus autocomplete="username" placeholder="Enter your registered email" />
