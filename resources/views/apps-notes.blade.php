            ...
            <div class="flex items-center justify-between p-5 border-b dark:border-zink-500">
                <div class="flex items-center gap-2">
                    <div class="relative dropdown">
                        <button
                            class="w-4 h-4 mt-1 border border-dashed rounded-full dropdown-toggle shrink-0 bg-sky-100 border-sky-500 dark:bg-sky-500/20"
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-5">
                <div class="flex items-center gap-2 mb-4">
                    <h6 class="text-sm font-normal grow"><i data-lucide="user-2"
                            class="inline-block w-4 h-4 mr-1 align-middle text-slate-500 fill-slate-200 dark:text-zink-200 dark:fill-zink-500"></i>
