    ...
    <div class="grid grid-cols-1 2xl:grid-cols-12 gap-x-5">
        <div class="2xl:col-span-3">
            <div class="card">
                <div class="card-body">
                    <div
                        class="flex items-center justify-center w-12 h-12 bg-purple-100 rounded-md dark:bg-purple-500/20 ltr:float-right rtl:float-left">
        ...
        <div class="2xl:col-span-3">
            <div class="card">
                <div class="card-body">
                    <div
                        class="flex items-center justify-center w-12 h-12 bg-orange-100 rounded-md dark:bg-orange-500/20 ltr:float-right rtl:float-left">
        ...
        <div class="2xl:col-span-3">
            <div class="card">
                <div class="card-body">
                    <div
                        class="flex items-center justify-center w-12 h-12 rounded-md ltr:float-right rtl:float-left bg-sky-100 dark:bg-sky-500/20">
