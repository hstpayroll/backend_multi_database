            ...
            <div class="card-body">
                ...
                <div class="flex flex-col border rounded-md dark:border-zink-300/20">
                    <label class="px-3.5 py-2.5 border-b dark:border-zink-300/20 flex items-center gap-2">
                        <input
                            class="w-4 h-4 border rounded-sm appearance-none bg-slate-100 border-slate-200 ltr:mr-1 rtl:ml-1 checked:bg-custom-500 checked:border-custom-500 dark:bg-zink-600 dark:border-zink-500 dark:checked:bg-custom-500 dark:checked:border-custom-500"
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="flex flex-col border rounded-md dark:border-zink-300/20">
                    <label class="px-3.5 py-2.5 border-b dark:border-zink-300/20 flex items-center gap-2">
                        <input
                            class="w-4 h-4 border rounded-full appearance-none bg-slate-100 border-slate-200 text-custom-600 checked:bg-custom-500 checked:border-custom-500 dark:bg-zink-600 dark:border-zink-500 dark:checked:bg-custom-500 dark:checked:border-custom-500"
