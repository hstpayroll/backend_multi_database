...
@section('content')
                    ...
                    <div class="flex items-center gap-3 mb-5">
                        ...
                        <div class="grow">
                            <h6 class="mb-1 text-15">Paula Keenan <i data-lucide="badge-check"
                                    class="inline-block w-4 h-4 text-sky-500 fill-sky-100 dark:fill-sky-500/20"></i></h6>
                    ...
                    <ul class="flex flex-col w-full gap-2 mb-4 text-sm font-medium shrink-0 nav-tabs">
                        <li class="group grow active">
                            <a href="{{ url('dashboards-social-media') }}"
                                class="inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 dark:text-zink-200 border border-transparent group-[.active]:bg-custom-500 dark:group-[.active]:bg-custom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-custom-500 dark:hover:text-custom-500 active:text-custom-500 dark:active:text-custom-500 -mb-[1px]"><i
                                    data-lucide="home" class="inline-block w-4 h-4 align-middle ltr:mr-1 rtl:ml-1"></i>
                                <span class="align-middle">Feed</span></a>
                        </li>
                        <li class="group grow">
                            <a href="{{ url('apps-social-friends') }}"
                                class="inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 dark:text-zink-200 border border-transparent group-[.active]:bg-custom-500 dark:group-[.active]:bg-custom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-custom-500 dark:hover:text-custom-500 active:text-custom-500 dark:active:text-custom-500 -mb-[1px]"><i
                                    data-lucide="user-2" class="inline-block w-4 h-4 align-middle ltr:mr-1 rtl:ml-1"></i>
                        ...
                        <li class="group grow">
                            <a href="{{ url('pages-account-settings') }}"
                                class="inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 dark:text-zink-200 border border-transparent group-[.active]:bg-custom-500 dark:group-[.active]:bg-custom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-custom-500 dark:hover:text-custom-500 active:text-custom-500 dark:active:text-custom-500 -mb-[1px]"><i
                                    data-lucide="settings" class="inline-block w-4 h-4 align-middle ltr:mr-1 rtl:ml-1"></i>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        ...
                        <a href="#!"
                            class="relative flex items-center justify-center w-10 h-10 rounded-full bg-custom-100 text-custom-500 dark:bg-custom-500/20">
                            5+
                        </a>
                    </div>
                </div>
        ...
        <div class="col-span-12 lg:col-span-7 xl:col-span-9 2xl:col-span-6">
                    ...
                    <div class="w-full" data-simplebar>
                        <div class="flex gap-4">
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active"
                                ...
                                <div
                                    class="w-16 h-16 mx-auto rounded-full bg-pink-100 dark:bg-pink-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-1.png') }}" alt=""
                                        class="w-16 h-16 rounded-full">
                                    <div
                                        class="absolute flex items-center justify-center w-5 h-5 text-white rounded-full ltr:-right-0.5 rtl:-left-0.5 -bottom-0.5 bg-sky-500">
                            ...
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active"
                                data-glightbox="max-width: 28rem;">
                                <div
                                    class="w-16 h-16 mx-auto rounded-full bg-sky-100 dark:bg-sky-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-2.png') }}" alt=""
                                        class="w-16 h-16 rounded-full">
                                </div>
                            ...
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active"
                                data-glightbox="max-width: 28rem;">
                                <div
                                    class="w-16 h-16 mx-auto rounded-full bg-slate-100 dark:bg-zink-600 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-3.png') }}" alt=""
                                        class="w-16 h-16 rounded-full">
                                </div>
                            ...
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active"
                                data-glightbox="max-width: 28rem;">
                                <div
                                    class="w-16 h-16 mx-auto rounded-full bg-yellow-100 dark:bg-yellow-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-4.png') }}" alt=""
                                        class="w-16 h-16 rounded-full">
                                </div>
                            ...
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active"
                                data-glightbox="max-width: 28rem;">
                                <div
                                    class="w-16 h-16 mx-auto rounded-full bg-emerald-100 dark:bg-emerald-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-5.png') }}" alt=""
                                        class="w-16 h-16 rounded-full">
                                </div>
                            ...
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story active"
                                data-glightbox="max-width: 28rem;">
                                <div
                                    class="w-16 h-16 mx-auto rounded-full bg-purple-100 dark:bg-purple-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-6.png') }}" alt=""
                                        class="w-16 h-16 rounded-full">
                                </div>
                            ...
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story"
                                data-glightbox="max-width: 28rem;">
                                <div
                                    class="w-16 h-16 mx-auto rounded-full bg-custom-100 dark:bg-custom-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-7.png') }}" alt=""
                                        class="w-16 h-16 rounded-full">
                                </div>
                            ...
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story"
                                data-glightbox="max-width: 28rem;">
                                <div
                                    class="w-16 h-16 mx-auto rounded-full bg-green-100 dark:bg-green-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-8.png') }}" alt=""
                                        class="w-16 h-16 rounded-full">
                                </div>
                            ...
                            <a href="#inline-example" class="block w-20 px-1 py-2 group highlight-story"
                                data-glightbox="max-width: 28rem;">
                                <div
                                    class="w-16 h-16 mx-auto rounded-full bg-cyan-100 dark:bg-cyan-500/20 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700 relative">
                                    <img src="{{ URL::asset('build/images/users/avatar-10.png') }}" alt=""
                                        class="w-16 h-16 rounded-full">
                                </div>
                            ...
                            <a href="#!" class="block w-20 px-1 py-2 group">
                                <div
                                    class="w-16 h-16 mx-auto rounded-full bg-slate-100 dark:bg-zink-600 outline-1 outline outline-slate-200 outline-offset-[3px] dark:outline-zink-500 group-[.active]:outline-custom-500 dark:group-[.active]:outline-custom-700">
                                    <img src="{{ URL::asset('build/images/users/avatar-3.png') }}" alt=""
                                        class="w-16 h-16 rounded-full">
                                </div>
                                <h6 class="mt-2 font-normal truncate">@christina</h6>
                ...
                <div class="card-body">
                        ...
                        <ul class="flex gap-3 grow">
                            <li>
                                <a href="#!"><i data-lucide="video"
                                        class="inline-block w-4 h-4 text-red-500 ltr:mr-1 rtl:ml-1"></i> <span
                            ...
                            <li>
                                <a href="#!" data-modal-target="imagesVideoPostModal"><i data-lucide="image"
                                        class="inline-block w-4 h-4 ltr:mr-1 text-custom-600 rtl:ml-1"></i> <span
                            ...
                            <li>
                                <a href="#!" data-modal-target="eventModal"><i data-lucide="calendar-days"
                                        class="inline-block w-4 h-4 text-green-500 ltr:mr-1 rtl:ml-1"></i> <span
                                        class="align-middle text-slate-500 dark:text-zink-200">Event</span></a>
                            </li>
                            <li>
                                <a href="#!"><i data-lucide="at-sign"
                                        class="inline-block w-4 h-4 ltr:mr-1 text-sky-500 rtl:ml-1"></i> <span
                                ...
                                <li>
                                    <a class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200 text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500"
                                        href="#!"><i data-lucide="git-pull-request"
                                            class="inline-block w-3 h-3 mr-1"></i> <span class="align-middle">Create a
                                            poll</span></a>
                                </li>
                                <li>
                                    <a class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200 text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500"
                                        href="#!"><i data-lucide="messages-square"
                                            class="inline-block w-3 h-3 mr-1"></i> <span class="align-middle">Ask a
                                            question</span></a>
                                </li>
                                <li>
                                    <a class="block px-4 py-1.5 text-base transition-all duration-200 ease-linear dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200 text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500"
                                        href="#!"><i data-lucide="help-circle"
                                            class="inline-block w-3 h-3 mr-1"></i> <span
                    ...
                    <form action="#!">
                        <div class="flex gap-3 mt-4">
                            <div class="bg-pink-100 rounded-full h-9 w-9 shrink-0 dark:bg-pink-500/20">
                                <img src="{{ URL::asset('build/images/users/avatar-1.png') }}" alt=""
            ...
            <div class="card">
                <div class="card-body">
                    <div class="flex flex-wrap items-center gap-3 mb-5">
                        <div
                            class="w-12 h-12 bg-green-100 rounded-full outline-1 outline outline-transparent outline-offset-[3px] [&.active]:outline-custom-500 shrink-0 dark:bg-green-500/20">
                            <img src="{{ URL::asset('build/images/users/avatar-8.png') }}" alt=""
                    ...
                    <ul class="flex items-center gap-4 mb-0">
                        <li>
                            <a href="#!" class="text-slate-500 dark:text-zink-200"><i data-lucide="messages-square"
                                    class="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">48
                                    Comments</span></a>
                        </li>
                        <li>
                            <a href="#!" class="text-slate-500 dark:text-zink-200"><i data-lucide="heart"
                                    class="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">257
                                    Likes</span></a>
                        </li>
                        <li>
                            <a href="#!" class="text-slate-500 dark:text-zink-200"><i data-lucide="send"
                                    class="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">13
                                    Share</span></a>
                        </li>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-5">
                        <div class="flex gap-3">
                            <div class="bg-yellow-100 rounded-full h-9 w-9 shrink-0 dark:bg-yellow-500/20">
                                <img src="{{ URL::asset('build/images/users/avatar-5.png') }}" alt=""
                                    class="rounded-full w-9 h-9">
                            </div>
                            <div class="grow">
                                ...
                                <div class="flex gap-3 mt-4">
                                    <div class="bg-green-100 rounded-full h-9 w-9 shrink-0 dark:bg-green-500/20">
                                        <img src="{{ URL::asset('build/images/users/avatar-8.png') }}" alt=""
                                            class="rounded-full w-9 h-9">
                                    </div>
                                    <div class="grow">
            ...
            <div class="card">
                ...
                <div class="border-y border-slate-200 card-body dark:border-zink-500">
                    <ul class="flex items-center gap-4 mb-0">
                        <li>
                            <a href="#!" class="text-slate-500 dark:text-zink-200"><i data-lucide="messages-square"
                                    class="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">224
                                    Comments</span></a>
                        </li>
                        <li>
                            <a href="#!" class="text-slate-500 dark:text-zink-200"><i data-lucide="heart"
                                    class="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">746
                                    Likes</span></a>
                        </li>
                        <li>
                            <a href="#!" class="text-slate-500 dark:text-zink-200"><i data-lucide="send"
                                    class="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">47
                                    Share</span></a>
                        </li>
                        <li class="ltr:ml-auto rtl:mr-auto">
                            <a href="#!" class="text-slate-500 dark:text-zink-200"><i data-lucide="bookmark"
            ...
            <div class="card">
                    ...
                    <ul
                            ...
                            <a href="#!" class="relative flex gap-4 group active">
                                <div class="absolute top-1 ltr:right-1 rtl:left-1">
                                    <i data-lucide="check-circle"
                                        class="w-4 h-4 text-green-500 fill-green-200 dark:fill-green-500/20 group-[&.active]:block hidden"></i>
                                </div>
                        ...
                        <li>
                            <a href="#!" class="relative flex gap-3 group">
                                <div class="absolute top-1 ltr:right-1 rtl:left-1">
                                    <i data-lucide="check-circle"
                                        class="w-4 h-4 text-green-500 fill-green-200 group-[&.active]:block hidden"></i>
                                </div>
                ...
                <div class="border-y border-slate-200 card-body dark:border-zink-500">
                    <ul class="flex items-center gap-4 mb-0">
                        <li>
                            <a href="#!" class="text-slate-500 dark:text-zink-200"><i data-lucide="messages-square"
                                    class="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">495
                                    Comments</span></a>
                        </li>
                        <li>
                            <a href="#!" class="text-slate-500 dark:text-zink-200"><i data-lucide="heart"
                                    class="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">1.3k
                                    Likes</span></a>
                        </li>
                        <li>
                            <a href="#!" class="text-slate-500 dark:text-zink-200"><i data-lucide="send"
                                    class="inline-block w-4 h-4 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">203
                                    Share</span></a>
                        </li>
                        <li class="ltr:ml-auto rtl:mr-auto">
                            <a href="#!" class="text-slate-500 dark:text-zink-200"><i data-lucide="bookmark"
            ...
            <div class="flex justify-center mb-5">
                <button type="button"
                    ...
                    <svg class="w-4 h-4 ltr:mr-2 rtl:ml-2 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24">
                ...
                <div class="card-body">
                    <div class="flex items-center gap-3">
                        <h6 class="mb-0 grow text-15">Message <span
                                class="inline-flex items-center justify-center w-6 h-6 text-xs font-medium border rounded rtl:mr-1 ltr:ml-1 bg-custom-100 border-custom-100 text-custom-500 dark:bg-custom-400/20 dark:border-transparent">15</span>
                        </h6>
                        <div class="shrink-0">
                ...
                <div class="card-body">
                    ...
                    <ul class="flex flex-col gap-3 mt-5">
                        <li>
                            <a href="#!"
                                class="flex items-center gap-3 transition-all duration-150 ease-linear group/items">
                                <div class="relative rounded-full w-9 h-9 bg-slate-100 dark:bg-zink-600">
                                    <img src="{{ URL::asset('build/images/users/avatar-3.png') }}" alt=""
    ...
    <div id="inline-example"
        ...
        <div class="relative flex flex-col h-full inline-inner">
            ...
            <div class="flex items-center gap-3 mb-5">
                <div
                    class="w-12 h-12 bg-green-100 rounded-full outline-1 outline outline-transparent outline-offset-[3px] [&.active]:outline-custom-500 shrink-0">
                    <img src="{{ URL::asset('build/images/users/avatar-8.png') }}" alt=""
                        class="w-12 h-12 rounded-full">
                </div>
                <div class="grow">
            ...
            <div class="flex items-center gap-2 pt-16 mt-auto">
                ...
                <button type="button"
                    class="flex items-center justify-center w-[37.5px] h-[37.5px] transition-all duration-200 ease-linear p-0 bg-white text-red-500 btn bg-transparent border-red-500 hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 active:text-white active:bg-red-600 active:border-red-600"><i
                        data-lucide="heart" class="w-4 h-4"></i></button>
            </div>
        </div>
    </div>
                            ...
                            <div class="w-full py-5 text-lg text-center dz-message needsclick">
                                <div class="mb-3">
                                    <i data-lucide="upload-cloud"
                                        class="block w-12 h-12 mx-auto text-slate-500 fill-slate-200 dark:text-zink-200 dark:fill-zink-600"></i>
                                </div>
                            ...
                            <li class="mt-5" id="dropzone-preview-list2">
                                ...
                                <div class="border rounded border-slate-200 dark:border-zink-500">
                                    <div class="p-2 text-center">
                                        <div>
                                            <div class="p-2 mx-auto rounded-md w-14 h-14 bg-slate-100 dark:bg-zink-500">
