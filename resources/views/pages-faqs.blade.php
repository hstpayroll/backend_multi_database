                ...
                <div class="xl:col-span-7">
                    ...
                    <div class="relative inline-block w-2/3">
                        ...
                        <i data-lucide="search"
                            class="inline-block w-4 h-4 absolute right-2.5 top-2.5 text-slate-400 fill-slate-100 dark:text-zink-200 dark:fill-zink-500"></i>
                    </div>
            ...
            <div class="collapsible">
                <button class="flex items-center w-full p-3 mb-2 text-left card collapsible-header group/item">
                    ...
                    <div class="ltr:ml-auto rtl:mr-auto shrink-0">
                        <i data-lucide="chevron-down" class="hidden w-4 h-4 group-[.show]/item:inline-block"></i>
                        <i data-lucide="chevron-up" class="inline-block w-4 h-4 group-[.show]/item:hidden"></i>
                    </div>
                </button>
