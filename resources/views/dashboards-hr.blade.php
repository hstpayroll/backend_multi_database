    ...
    @endsection
    @push('css')
        <link rel="stylesheet" href="{{ URL::asset('build/libs/vanilla-calendar-pro/build/vanilla-calendar.min.css') }}">
    @endpush
    @section('content')
        <!-- page title -->
                ...
                <div class="card-body">
                    <div class="flex items-center gap-2 MB-3">
                        ...
                        <div class="relative flex items-center gap-2 dropdown shrink-0">
                            <button type="button"
                                class="flex items-center justify-center w-8 h-8 p-0 text-xs text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">All</button>
                            <button type="button"
                                class="flex items-center justify-center w-8 h-8 p-0 text-xs transition-all duration-200 ease-linear text-sky-500 btn bg-sky-100 hover:text-white hover:bg-sky-600 focus:text-white focus:bg-sky-600 focus:ring focus:ring-sky-100 active:text-white active:bg-sky-600 active:ring active:ring-sky-100 dark:bg-sky-500/20 dark:text-sky-400 dark:hover:bg-sky-500 dark:hover:text-white dark:focus:bg-sky-500 dark:focus:text-white dark:active:bg-sky-500 dark:active:text-white dark:ring-sky-400/20">1M</button>
                            <button type="button"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <div class="flex gap-2">
                                            <div class="w-10 h-10 bg-green-100 rounded-full dark:bg-green-500/20 shrink-0">
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                        <div class="flex gap-2">
                                            <div class="w-10 h-10 rounded-full bg-sky-100 dark:bg-sky-500/20 shrink-0">
                                ...
                                <tr>
                                    ...
                                    <td
                                        class="px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500">
                                        <div class="flex gap-2">
                                            <div class="w-10 h-10 rounded-full bg-slate-100 dark:bg-zink-600 shrink-0">
                                ...
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <div class="flex gap-2">
                                            <div
                                                class="w-10 h-10 bg-yellow-100 rounded-full dark:bg-yellow-500/20 shrink-0">
            ...
            <div
                ...
                <div class="card-body">
                    ...
                    <div class="flex flex-col gap-4 mt-3">
                        <div class="flex gap-3">
                            <div
                                class="flex flex-col items-center justify-center w-12 h-12 border rounded-sm border-slate-200 dark:border-zink-500 shrink-0">
                    ...
                    <div
                        ...
                        <div class="relative card-body">
                            <div class="flex gap-3 mb-4">
                                <div class="w-10 h-10 bg-purple-100 rounded-full dark:bg-purple-500/20 shrink-0">
                            ...
                            <div data-simplebar class="flex flex-col h-[198px] gap-4 px-5">
                                <div class="flex flex-col gap-3">
                                    <div class="flex flex-wrap items-center gap-3">
                                        <div
                                            class="flex items-center justify-center w-6 h-6 text-red-500 rounded-full shrink-0">
                                    ...
                                    <div class="flex flex-wrap items-center gap-3">
                                        <div
                                            class="flex items-center justify-center w-6 h-6 text-green-500 rounded-full shrink-0">
