...
@section('content')
    ...
    <div class="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
        <div class="card">
            <div class="card-body">
                <h5 class="mb-2"><i data-lucide="goal" class="inline-block w-5 h-5 mr-1 text-green-500"></i> <span
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="mb-2"><i data-lucide="graduation-cap" class="inline-block w-5 h-5 mr-1 text-purple-500"></i>
                ...
                <ul class="flex flex-col gap-3 mt-5">
                    ...
                    <li class="flex items-center gap-2 line-through text-slate-500 dark:text-zink-200">
                        <i data-lucide="x" class="inline-block w-4 h-4 text-red-500 fill-red-100"></i>
                        <span><b>5</b> FTP Login</span>
                    </li>
                    <li class="flex items-center gap-2 line-through text-slate-500 dark:text-zink-200">
                        <i data-lucide="x" class="inline-block w-4 h-4 text-red-500 fill-red-100"></i>
        ...
        <div class="relative overflow-hidden card">
            <div class="card-body">
                ...
                <h5 class="mb-2"><i data-lucide="crown" class="inline-block w-5 h-5 mr-1 text-sky-500"></i> <span
        ...
        <div class="card">
            <div class="card-body">
                <h5 class="mb-2"><i data-lucide="luggage" class="inline-block w-5 h-5 mr-1 text-orange-500"></i> <span
                    ...
                    <div class="xl:col-span-8">
                        ...
                        <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                            <div>
                                <ul class="flex flex-col gap-3 mt-5">
                                    <li class="flex items-center gap-2">
                                        <i data-lucide="check-square" class="inline-block w-4 h-4 text-green-500"></i>
                                        <span><b>3</b> Projects</span>
                                    </li>
                                    <li class="flex items-center gap-2">
                                        <i data-lucide="check-square" class="inline-block w-4 h-4 text-green-500"></i>
