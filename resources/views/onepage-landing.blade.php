...
<body class="text-base bg-white text-body font-public dark:text-zink-50 dark:bg-zink-800">
    ...
    <nav class="fixed inset-x-0 top-0 z-50 flex items-center justify-center h-20 py-3 [&.is-sticky]:bg-white dark:[&.is-sticky]:bg-zink-700 border-b border-slate-200 dark:border-zink-500 [&.is-sticky]:shadow-lg [&.is-sticky]:shadow-slate-200/25 dark:[&.is-sticky]:shadow-zink-500/30 navbar" id="navbar">
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto flex items-center self-center w-full">
            ...
            <div class="flex gap-2">
                ...
                <button type="button" class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><span class="align-middle">Sign In</span> <i data-lucide="log-in" class="inline-block w-4 h-4 ltr:ml-1 rtl:mr-1"></i></button>
            </div>
        </div>
    </nav>

    <section class="relative pb-36 pt-44" id="home">
        <div class="absolute rotate-45 border border-dashed h-[500px] w-[500px] border-t-slate-300 dark:border-t-zink-500 border-l-slate-300 dark:border-l-zink-500 border-r-slate-700 dark:border-r-zink-400 border-b-slate-700 dark:border-b-zink-400 -bottom-[250px] rounded-full ltr:right-40 rtl:left-40 z-10 hidden lg:block"></div>
        <div class="absolute rotate-45 border border-dashed h-[700px] w-[700px] border-t-slate-300 dark:border-t-zink-500 border-l-slate-300 dark:border-l-zink-500 border-r-slate-700 dark:border-r-zink-400 border-b-slate-700 dark:border-b-zink-400 -bottom-[350px] rounded-full ltr:right-16 rtl:left-16 z-10 hidden 2xl:block"></div>
    ...
    <section class="relative py-32 bg-slate-900 dark:bg-zink-700" id="features">
        ...
        <div class="absolute rotate-45 border border-dashed h-[500px] w-[500px] border-t-slate-700 border-l-slate-700 border-r-slate-700 border-b-slate-700 bottom-48 rounded-full ltr:-left-80 rtl:-right-80 hidden md:block"></div>
        <div class="absolute rotate-45 border border-dashed h-[700px] w-[700px] border-t-slate-700 border-l-slate-700 border-r-slate-700 border-b-slate-700 bottom-24 rounded-full ltr:-left-96 rtl:-right-96 hidden md:block"></div>
    </section>
                    ...
                    <div class="transition-all duration-300 ease-linear -mt-36 card hover:-translate-y-2 dark:bg-zink-600">
                        <div class="p-6">
                            ...
                            <div class="mt-6">
                                ...
                                <a href="#!" class="text-custom-500 text-16">Read More <i data-lucide="move-right" class="inline-block w-4 h-4 align-middle ltr:ml-1 rtl:mr-1 rtl:rotate-180"></i></a>
                            </div>
                        </div>
                    </div>
                </div><!--end col-->
        ...
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            ...
            <div class="grid items-center grid-cols-1 gap-6 mt-20 lg:grid-cols-12">
                <div class="lg:col-span-5">
                    ...
                    <button type="button" class="py-2.5 px-6 bg-white text-custom-500 btn border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:bg-zink-700 dark:hover:bg-custom-500 dark:ring-custom-400/20 dark:focus:bg-custom-500"><span class="align-middle">Discover Now</span> <i data-lucide="move-right" class="inline-block w-4 h-4 align-middle ltr:ml-1 rtl:mr-1 rtl:rotate-180"></i></button>
                </div><!--end col-->
        ...
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            ...
            <div class="grid grid-cols-1 mt-16 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
                <div class="!shadow-lg text-15 card">
                    <div class="card-body">
                        <h5 class="mb-2"><i data-lucide="goal" class="inline-block w-5 h-5 text-green-500 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">Lite</span></h5>
                        ...
                        <ul class="flex flex-col gap-3 mt-5">
                            <li class="flex items-center gap-2">
                                <i data-lucide="check-check" class="inline-block w-4 h-4 text-green-500 fill-green-100 dark:fill-green-500/20"></i>
                ...
                <div class="!shadow-lg text-15 card">
                    <div class="card-body">
                        <h5 class="mb-2"><i data-lucide="graduation-cap" class="inline-block w-5 h-5 text-purple-500 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">Professional</span></h5>
                ...
                <div class="relative overflow-hidden card !shadow-lg text-15">
                    <div class="card-body">
                        ...
                        <h5 class="mb-2"><i data-lucide="crown" class="inline-block w-5 h-5 ltr:mr-1 rtl:ml-1 text-sky-500"></i> <span class="align-middle">Enterprise</span></h5>
                ...
                <div class="!shadow-lg text-15 card">
                    <div class="card-body">
                        <h5 class="mb-2"><i data-lucide="luggage" class="inline-block w-5 h-5 text-orange-500 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">Unlimited</span></h5>
    ...
    <section class="relative py-20 bg-custom-600 dark:bg-custom-800" id="contact">
        <div class="absolute rotate-45 border border-dashed h-[500px] w-[500px] border-t-custom-500 border-l-custom-500 border-r-slate-700 border-b-slate-700 -bottom-[250px] rounded-full ltr:right-40 rtl:left-40 z-10 hidden lg:block"></div>
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
                ...
                <div class="relative z-10 grid grid-cols-1 gap-5 md:grid-cols-12">
                    ...
                    <div class="md:col-span-3 md:col-start-10">
                        <ul class="flex items-center gap-3 md:justify-end">
                            <li>
                                <a href="#!" class="flex items-center justify-center w-10 h-10 transition-all duration-200 ease-linear border rounded-full text-slate-400 border-slate-700 hover:text-custom-500"><i data-lucide="facebook" class="w-4 h-4"></i></a>
                            </li>
                            <li>
                                <a href="#!" class="flex items-center justify-center w-10 h-10 transition-all duration-200 ease-linear border rounded-full text-slate-400 border-slate-700 hover:text-custom-500"><i data-lucide="linkedin" class="w-4 h-4"></i></a>
                            </li>
                            <li>
                                <a href="#!" class="flex items-center justify-center w-10 h-10 transition-all duration-200 ease-linear border rounded-full text-slate-400 border-slate-700 hover:text-custom-500"><i data-lucide="instagram" class="w-4 h-4"></i></a>
                            </li>
                            <li>
                                <a href="#!" class="flex items-center justify-center w-10 h-10 transition-all duration-200 ease-linear border rounded-full text-slate-400 border-slate-700 hover:text-custom-500"><i data-lucide="twitter" class="w-4 h-4"></i></a>
                            </li>
                            <li>
                                <a href="#!" class="flex items-center justify-center w-10 h-10 transition-all duration-200 ease-linear border rounded-full text-slate-400 border-slate-700 hover:text-custom-500"><i data-lucide="youtube" class="w-4 h-4"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
