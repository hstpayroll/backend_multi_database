    ...
    <div class="grid grid-cols-12 2xl:grid-cols-12 gap-x-5">
        <div class="relative col-span-12 overflow-hidden card 2xl:col-span-8 bg-slate-900">
            <div class="absolute inset-0">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-100 h-100" version="1.1"
                    ...
                    <div class="relative">
                        <a href="#!"
                            ...
                            All <i data-lucide="move-right"
                                class="inline-block w-4 h-4 align-middle ltr:ml-1 rtl:mr-1"></i></a>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-4 mb-4 md:mb-3 md:items-center md:flex-row">
                    ...
                    <div class="relative">
                        <i data-lucide="calendar-range"
                            class="absolute w-4 h-4 ltr:left-3 rtl:right-3 top-3 text-slate-500 dark:text-zink-200"></i>
                        <input type="text"
                ...
                <div class="grid grid-cols-12 gap-4 mb-3">
                    <div class="col-span-12 md:col-span-6 lg:col-span-3">
                        <div class="flex items-center gap-3">
                            <div
                                class="flex items-center justify-center w-12 h-12 rounded-md text-sky-500 bg-sky-50 shrink-0 dark:bg-sky-500/10">
                    ...
                    <div class="col-span-12 md:col-span-6 lg:col-span-3">
                        <div class="flex items-center gap-3">
                            <div
                                class="flex items-center justify-center w-12 h-12 text-green-500 rounded-md bg-green-50 shrink-0 dark:bg-green-500/10">
                        ...
                        <div class="flex items-center mb-2">
                            ...
                            <span
                                class="px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-white border-red-100 text-red-500 dark:bg-zink-700 dark:border-red-900"><i
                                    data-lucide="trending-down" class="inline-block w-3 h-3 ltr:mr-1 rtl:ml-1"></i>
                                6.8%</span>
                        </div>
                ...
                <ul class="divide-y divide-slate-200 dark:divide-zink-500">
                    <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                        <div class="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                            <img src="{{ URL::asset('build/images/users/avatar-2.png') }}" alt="" class="w-8 h-8 rounded-full">
                        </div>
                        <div class="grow">
                    ...
                    <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                        <div class="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                            <img src="{{ URL::asset('build/images/users/avatar-3.png') }}" alt="" class="w-8 h-8 rounded-full">
                        </div>
                        <div class="grow">
                    ...
                    <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                        <div class="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                            <img src="{{ URL::asset('build/images/users/avatar-4.png') }}" alt="" class="w-8 h-8 rounded-full">
                        </div>
                        <div class="grow">
                    ...
                    <li class="flex items-center gap-3 py-2 first:pt-0 last:pb-0">
                        <div class="w-8 h-8 rounded-full shrink-0 bg-slate-100 dark:bg-zink-600">
                            <img src="{{ URL::asset('build/images/users/avatar-5.png') }}" alt="" class="w-8 h-8 rounded-full">
                        </div>
                        <div class="grow">
                ...
                <ul class="flex flex-col gap-5">
                    <li class="flex items-center gap-3">
                        <div class="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                            <img src="{{ URL::asset('build/images/product/img-02.png') }}" alt="" class="h-6">
                        </div>
                        ...
                        <h6 class="shrink-0"><i data-lucide="shopping-cart"
                                class="inline-block w-4 h-4 align-middle text-slate-500 dark:text-zink-200 ltr:mr-1 rtl:ml-1"></i>
                            798</h6>
                    </li>
                    <li class="flex items-center gap-3">
                        <div class="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                            <img src="{{ URL::asset('build/images/product/img-03.png') }}" alt="" class="h-6">
                        </div>
                        <div class="overflow-hidden grow">
                    ...
                    <li class="flex items-center gap-3">
                        <div class="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                            <img src="{{ URL::asset('build/images/product/img-04.png') }}" alt="" class="h-6">
                        </div>
                        <div class="overflow-hidden grow">
                    ...
                    <li class="flex items-center gap-3">
                        <div class="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                            <img src="{{ URL::asset('build/images/product/img-05.png') }}" alt="" class="h-6">
                        </div>
                        <div class="overflow-hidden grow">
                    ...
                    <li class="flex items-center gap-3">
                        <div class="flex items-center justify-center w-10 h-10 rounded-md bg-slate-100 dark:bg-zink-600">
                            <img src="{{ URL::asset('build/images/product/img-06.png') }}" alt="" class="h-6">
                        </div>
                        <div class="overflow-hidden grow">
