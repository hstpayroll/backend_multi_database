...
<body class="text-base bg-white text-body font-public dark:text-zink-50 dark:bg-zink-800">
        ...
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto flex items-center self-center w-full">
            ...
            <div class="mx-auto">
                <ul id="navbar7"
                    ...
                    <li>
                        <a href="#features"
                            class="block md:inline-block px-4 md:px-3 py-2.5 md:py-0.5 text-15 font-medium text-slate-800 transition-all duration-300 ease-linear hover:text-custom-500 [&.active]:text-custom-500 dark:text-zink-100 dark:hover:text-custom-500 dark:[&.active]:text-custom-500">Our
                            Features</a>
                    </li>
                    <li>
                        <a href="#about"
                    ...
                    <li>
                        <a href="#pricing"
                            class="block md:inline-block px-4 md:px-3 py-2.5 md:py-0.5 text-15 font-medium text-slate-800 transition-all duration-300 ease-linear hover:text-custom-500 [&.active]:text-custom-500 dark:text-zink-100 dark:hover:text-custom-500 dark:[&.active]:text-custom-500">Pricing</a>
                    </li>
                    <li>
                        <a href="#contact"
            ...
            <div class="flex gap-2">
                ...
                <a type="button" href="{{ route('login') }}"
                    class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><span
                        class="align-middle">Sign In</span> <i data-lucide="log-in"
                        class="inline-block w-4 h-4 ltr:ml-1 rtl:mr-1"></i></a>
            </div>
        </div>
    </nav>
    ...
    <section class="relative pb-36 pt-44" id="home">
        <div
            class="absolute rotate-45 border border-dashed h-[500px] w-[500px] border-t-slate-300 dark:border-t-zink-500 border-l-slate-300 dark:border-l-zink-500 border-r-slate-700 dark:border-r-zink-400 border-b-slate-700 dark:border-b-zink-400 -bottom-[250px] rounded-full ltr:right-40 rtl:left-40 z-10 hidden lg:block">
        </div>
        <div
            class="absolute rotate-45 border border-dashed h-[700px] w-[700px] border-t-slate-300 dark:border-t-zink-500 border-l-slate-300 dark:border-l-zink-500 border-r-slate-700 dark:border-r-zink-400 border-b-slate-700 dark:border-b-zink-400 -bottom-[350px] rounded-full ltr:right-16 rtl:left-16 z-10 hidden 2xl:block">
        </div>
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            <div class="grid grid-cols-12 2xl:grid-cols-2">
                <div class="col-span-12 lg:col-span-7 2xl:col-span-1">
                    <h1 class="mb-8 !leading-relaxed md:text-5xl">Effective Management of Large Projects at <span
                            class="relative inline-block px-2 mx-2 before:block before:absolute before:-inset-1 before:-skew-y-6 before:bg-sky-50 dark:before:bg-sky-500/20 before:rounded-md before:backdrop-blur-xl"><span
                                class="relative text-sky-500">Tailwick</span></span></h1>
                    <p class="mb-6 text-lg text-slate-500 dark:text-zink-200">Effective professional services project
                        management means having a firm grasp on the scope, budget, resources, personnel, and timeline
                        dedicated to a project. An effective project manager is able to manage unplanned issues while
                        keeping the ball rolling on company goals and tasks in progress.</p>
                    <div class="flex items-center gap-2">
                        <button type="button"
                            class="py-2.5 px-6 text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20"><i
                                data-lucide="rocket" class="inline-block w-4 h-4 align-middle rtl:ml-1 ltr:mr-1"></i>
                            Get Started</button>
                        <button type="button"
                            class="py-2.5 px-6 text-red-500 bg-white border-red-500 border-dashed btn hover:text-red-500 hover:bg-red-50 hover:border-red-600 focus:text-red-600 focus:bg-red-50 focus:border-red-600 active:text-red-600 active:bg-red-50 active:border-red-600 dark:bg-zink-800 dark:ring-red-400/20 dark:hover:bg-red-800/20 dark:focus:bg-red-800/20 dark:active:bg-red-800/20"><i
                                ...
                                class="inline-block w-4 h-4 align-middle rtl:ml-1 ltr:mr-1"></i> <span
                                class="align-middle">Buy Now</span></button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="order-2 xl:col-span-5 xl:order-1">
                    <div class="relative z-10 grid grid-cols-3 gap-5 xl:grid-cols-12">
                        <div class="xl:col-span-12">
                            <img src="{{ URL::asset('build/images/landing/widgets.jpg') }}" alt=""
                                class="shadow-xl rtl:mr-auto ltr:ml-auto rounded-xl">
                        </div>
                        <div class="xl:col-span-6">
                            <img src="{{ URL::asset('build/images/landing/widgets-3.jpg') }}" alt=""
                                class="shadow-xl xl:mt-5 rtl:mr-auto ltr:ml-auto rounded-xl">
                        </div>
                        <div class="xl:col-span-6">
                            <img src="{{ URL::asset('build/images/landing/widgets-2.jpg') }}" alt=""
                                class="shadow-xl xl:mt-5 rtl:mr-auto ltr:ml-auto rounded-xl">
                        </div>
                    </div>
                </div>
                <div class="relative z-20 order-1 xl:-mt-72 xl:col-span-7 xl:order-last">
                    <img src="{{ URL::asset('build/images/landing/home.jpg') }}" alt=""
                        class="shadow-2xl rounded-xl">
                </div>
            </div>
            <div class="mt-24">
                <h1 class="mb-16 leading-normal capitalize text-slate-100 dark:text-zink-50">Build for anyone who works
                    with Tailwick</h1>
            </div>
        </div>
        <div
            class="absolute rotate-45 border border-dashed h-[500px] w-[500px] border-t-slate-700 border-l-slate-700 border-r-slate-700 border-b-slate-700 bottom-48 rounded-full ltr:-left-80 rtl:-right-80 hidden md:block">
        </div>
        <div
            class="absolute rotate-45 border border-dashed h-[700px] w-[700px] border-t-slate-700 border-l-slate-700 border-r-slate-700 border-b-slate-700 bottom-24 rounded-full ltr:-left-96 rtl:-right-96 hidden md:block">
        </div>
    </section>
        ...
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-12 gap-x-5">
                <div class="xl:col-span-4">
                    <div
                        class="transition-all duration-300 ease-linear -mt-36 card hover:-translate-y-2 dark:bg-zink-600">
                        <div class="p-6">
                            <img src="{{ URL::asset('build/images/landing/chat.jpg') }}" alt=""
                                class="rounded-md shadow">
                            <div class="mt-6">
                                <span
                                    class="px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-sky-100 border-sky-200 text-sky-500 dark:bg-sky-500/20 dark:border-sky-500/20">Popular
                                    Apps</span>
                                <h6 class="mt-3 mb-2 text-lg truncate"><a href="#!">Chat with Client &
                                        Employee</a></h6>
                                <p class="mb-3 text-slate-500 dark:text-zink-200 text-16">A chat UI, or user interface,
                                    is one of the first things users see when using a web or mobile application to
                                    communicate.</p>
                                <a href="#!" class="text-custom-500 text-16">Read More <i
                                        data-lucide="move-right"
                                        class="inline-block w-4 h-4 align-middle ltr:ml-1 rtl:mr-1 rtl:rotate-180"></i></a>
                            </div>
                        </div>
                    </div>
                </div><!--end col-->
                <div class="xl:col-span-4">
                    <div
                        class="transition-all duration-300 ease-linear md:-mt-36 card hover:-translate-y-2 dark:bg-zink-600">
                        <div class="p-6">
                            <img src="{{ URL::asset('build/images/landing/email.jpg') }}" alt=""
                                class="rounded-md shadow">
                            <div class="mt-6">
                                <span
                                    class="px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-purple-100 border-purple-200 text-purple-500 dark:bg-purple-500/20 dark:border-purple-500/20">Email
                                    Apps</span>
                                <h6 class="mt-3 mb-2 text-lg truncate"><a href="#!">Exciting New Features Await
                                        You</a></h6>
                                <p class="mb-3 text-slate-500 dark:text-zink-200 text-16">A chat UI, or user interface,
                                    is one of the first things users see when using a web or mobile application to
                                    communicate.</p>
                ...
                <div class="xl:col-span-4">
                    <div
                        ...
                        <div class="p-6">
                            <img src="{{ URL::asset('build/images/landing/order-overview.jpg') }}" alt=""
                                class="rounded-md shadow">
                            <div class="mt-6">
                                <span
                                    class="px-2.5 py-0.5 text-xs inline-block font-medium rounded border bg-red-100 border-red-200 text-red-500 dark:bg-red-500/20 dark:border-red-500/20">HR
                                    Management</span>
                                <h6 class="mt-3 mb-2 text-lg truncate"><a href="#!">Unleash Your Creativity with
                                        Our Latest Tools</a></h6>
                                <p class="mb-3 text-slate-500 dark:text-zink-200 text-16">A chat UI, or user interface,
                                    is one of the first things users see when using a web or mobile application to
                                    communicate.</p>
                                <a href="#!" class="text-custom-500 text-16">Read More <i
    ...
    <section class="relative py-32" id="about">
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            <div class="mx-auto text-center xl:max-w-3xl">
                <h1 class="mb-6 leading-normal capitalize">Why Developers Should Embrace <span
                        class="relative inline-block px-2 mx-2 before:block before:absolute before:-inset-1 before:-skew-y-6 before:bg-sky-50 dark:before:bg-sky-500/20 before:rounded-md before:backdrop-blur-xl"><span
                            class="relative text-sky-500">Tailwick</span></span></h1>
                <p class="text-lg text-slate-500 dark:text-zink-200">The purpose of developer communities is to provide
                    the resources for developers to learn anything they want to.</p>
            </div>

            <div class="grid items-center grid-cols-1 gap-6 mt-20 lg:grid-cols-12">
                <div class="lg:col-span-5">
                    <h1 class="mb-3 leading-normal capitalize">Craft a Complete Website Quickly with the Help of Design
                        Blocks</h1>
                    <p class="mb-6 text-lg text-slate-500 dark:text-zink-200">The block design approach basically
                        breaks the design into small parts. These are built independently and then later combine into a
                        customizable page which makes a website more flexible in terms of layout and content.</p>
                    <button type="button"
                        class="py-2.5 px-6 bg-white text-custom-500 btn border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:bg-zink-700 dark:hover:bg-custom-500 dark:ring-custom-400/20 dark:focus:bg-custom-500"><span
                            class="align-middle">Discover Now</span> <i data-lucide="move-right"
                            class="inline-block w-4 h-4 align-middle ltr:ml-1 rtl:mr-1 rtl:rotate-180"></i></button>
                </div><!--end col-->
                <div class="text-center lg:col-span-6">
                    <img src="{{ URL::asset('build/images/landing/widgets-4.jpg') }}" alt=""
                        class="shadow-lg ltr:lg:ml-auto rtl:lg:mr-auto rounded-xl">
                    <img src="{{ URL::asset('build/images/landing/widgets-5.jpg') }}" alt=""
            ...
            <div class="grid items-center grid-cols-1 gap-6 mt-32 lg:grid-cols-12">
                <div class="text-center lg:col-span-6">
                    <img src="{{ URL::asset('build/images/landing/widgets-6.jpg') }}" alt=""
                        class="shadow-lg ltr:mr-auto rtl:ml-auto rounded-xl">
                    <img src="{{ URL::asset('build/images/landing/widgets-7.jpg') }}" alt=""
                        class="relative -mt-24 shadow-lg ltr:ml-auto ltr:mr-24 rtl:mr-auto rtl:ml-24 rounded-xl">
                </div><!--end col-->
                <div class="lg:col-span-5">
            ...
            <div class="grid items-center grid-cols-1 gap-5 mt-32 lg:grid-cols-12">
                <div class="lg:col-span-5">
                    ...
                    <p class="mb-4 text-lg text-slate-500 dark:text-zink-200">With a user-friendly interface and easy
                        navigation, the user decreases search time and increases satisfaction, fulfilling his needs in a
    ...
    <section class="relative pb-32" id="pricing">
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            <div class="mx-auto text-center xl:max-w-3xl">
                ...
                <p class="text-lg text-slate-500 dark:text-zink-200">A good web design package will include designing a
                    logo, ingratiation with local SEO, linking a site to a social media presence, and more.</p>
            </div>

            <div class="grid grid-cols-1 mt-16 gap-x-5 md:grid-cols-2 xl:grid-cols-4">
                <div class="!shadow-lg text-15 card">
                    <div class="card-body">
                        <h5 class="mb-2"><i data-lucide="goal"
                                class="inline-block w-5 h-5 text-green-500 ltr:mr-1 rtl:ml-1"></i> <span
                        ...
                        <h1 class="mb-4 font-normal"><span
                                class="text-slate-400 dark:text-zink-200">$</span>9.99<small
                        ...
                        <ul class="flex flex-col gap-3 mt-5">
                            <li class="flex items-center gap-2">
                                <i data-lucide="check-check"
                                    class="inline-block w-4 h-4 text-green-500 fill-green-100 dark:fill-green-500/20"></i>
                            ...
                            <li class="flex items-center gap-2 line-through text-slate-500 dark:text-zink-200">
                                <i data-lucide="x" class="inline-block w-4 h-4 text-red-500 fill-green-100"></i>
                ...
                <div class="!shadow-lg text-15 card">
                    <div class="card-body">
                        <h5 class="mb-2"><i data-lucide="graduation-cap"
                                class="inline-block w-5 h-5 text-purple-500 ltr:mr-1 rtl:ml-1"></i> <span
                                class="align-middle">Professional</span></h5>
                        <p class="mb-4 text-slate-500 dark:text-zink-200">For users who want to do more.</p>

                        <h1 class="mb-4 font-normal"><span
                                class="text-slate-400 dark:text-zink-200">$</span>29.99<small
                                class="text-15 text-slate-500 dark:text-zink-200">/Monthly</small></h1>
                        <button type="button"
                            class="w-full bg-white border-dashed text-custom-500 btn border-custom-500 hover:text-custom-500 hover:bg-custom-50 hover:border-custom-600 focus:text-custom-600 focus:bg-custom-50 focus:border-custom-600 active:text-custom-600 active:bg-custom-50 active:border-custom-600 dark:bg-zink-700 dark:ring-custom-400/20 dark:hover:bg-custom-800/20 dark:focus:bg-custom-800/20 dark:active:bg-custom-800/20">Purchase
                            Now</button>
                ...
                <div class="relative overflow-hidden card !shadow-lg text-15">
                    <div class="card-body">
                        <div class="absolute top-0 w-16 h-16 ltr:right-0 rtl:left-0">
                            <div
                                class="absolute transform ltr:rotate-45 rtl:-rotate-45 bg-sky-500 text-center text-white font-medium py-1 ltr:-right-12 rtl:-left-12 top-6 w-[170px]">
                                25% Sale
                            </div>
                        </div>
                        <h5 class="mb-2"><i data-lucide="crown"
                                class="inline-block w-5 h-5 ltr:mr-1 rtl:ml-1 text-sky-500"></i> <span
                                class="align-middle">Enterprise</span></h5>
                        <p class="mb-4 text-slate-500 dark:text-zink-200">Run your company on your teams</p>

                        <h1 class="mb-4 font-normal"><span
                                class="text-slate-400 dark:text-zink-200">$</span>39.99<small
                                class="text-15 text-slate-500 dark:text-zink-200">/Monthly</small></h1>
                        <button type="button"
                            class="w-full bg-white border-dashed text-custom-500 btn border-custom-500 hover:text-custom-500 hover:bg-custom-50 hover:border-custom-600 focus:text-custom-600 focus:bg-custom-50 focus:border-custom-600 active:text-custom-600 active:bg-custom-50 active:border-custom-600 dark:bg-zink-700 dark:ring-custom-400/20 dark:hover:bg-custom-800/20 dark:focus:bg-custom-800/20 dark:active:bg-custom-800/20">Purchase
                            Now</button>
                ...
                <div class="!shadow-lg text-15 card">
                    <div class="card-body">
                        <h5 class="mb-2"><i data-lucide="luggage"
                                class="inline-block w-5 h-5 text-orange-500 ltr:mr-1 rtl:ml-1"></i> <span
                                class="align-middle">Unlimited</span></h5>
                        <p class="mb-4 text-slate-500 dark:text-zink-200">Your entire team in one place</p>

                        <h1 class="mb-4 font-normal"><span
                                class="text-slate-400 dark:text-zink-200">$</span>49.99<small
                                class="text-15 text-slate-500 dark:text-zink-200">/Monthly</small></h1>
                        <button type="button"
                            class="w-full bg-white border-dashed text-custom-500 btn border-custom-500 hover:text-custom-500 hover:bg-custom-50 hover:border-custom-600 focus:text-custom-600 focus:bg-custom-50 focus:border-custom-600 active:text-custom-600 active:bg-custom-50 active:border-custom-600 dark:bg-zink-700 dark:ring-custom-400/20 dark:hover:bg-custom-800/20 dark:focus:bg-custom-800/20 dark:active:bg-custom-800/20">Purchase
                            Now</button>
    ...
    <section class="relative py-20 bg-custom-600 dark:bg-custom-800" id="contact">
        <div
            class="absolute rotate-45 border border-dashed h-[500px] w-[500px] border-t-custom-500 border-l-custom-500 border-r-slate-700 border-b-slate-700 -bottom-[250px] rounded-full ltr:right-40 rtl:left-40 z-10 hidden lg:block">
        </div>
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            <div class="grid items-center grid-cols-1 gap-5 lg:grid-cols-12">
                <div class="lg:col-span-9">
                    ...
                    <p class="text-lg text-custom-200">Tell us which describes you, and we'll get in touch with next
                        steps.</p>
                </div>
                <div class="ltr:lg:text-right rtl:lg:text-left lg:col-span-3">
                    <button type="button"
                        class="py-2.5 px-6 text-base transition-all duration-200 ease-linear bg-white text-custom-500 btn border-white hover:text-custom-600 hover:bg-white hover:border-white z-10 relative"><i
                            data-lucide="shopping-cart"
                            class="inline-block w-4 h-4 align-middle ltr:mr-1 rtl:ml-1"></i> <span
                            class="align-middle">Purchase Now</span></button>
                </div>
            </div>
        </div><!--end container-->
    </section>
        ...
        <div class="container 2xl:max-w-[87.5rem] px-4 mx-auto">
            <div class="relative z-10 grid grid-cols-12 gap-5 xl:grid-cols-12">
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3">
                    ...
                    <ul class="flex flex-col gap-3 text-15">
                        <li>
                            <a href="#!"
                                class="relative inline-block transition-all duration-200 ease-linear text-slate-400 dark:text-zink-200 hover:text-slate-300 dark:hover:text-zink-50 before:absolute before:border-b before:border-slate-500 dark:before:border-zink-500 before:inset-x-0 before:bottom-0 before:w-0 hover:before:w-full before:transition-all before:duration-300 before:ease-linear">Ecommerce
                                Apps</a>
                        </li>
                        <li>
                            <a href="#!"
                        ...
                        <li>
                            <a href="#!"
                                class="relative inline-block transition-all duration-200 ease-linear text-slate-400 dark:text-zink-200 hover:text-slate-300 dark:hover:text-zink-50 before:absolute before:border-b before:border-slate-500 dark:before:border-zink-500 before:inset-x-0 before:bottom-0 before:w-0 hover:before:w-full before:transition-all before:duration-300 before:ease-linear">Email
                                App</a>
                        </li>
                        <li>
                            <a href="#!"
                                class="relative inline-block transition-all duration-200 ease-linear text-slate-400 dark:text-zink-200 hover:text-slate-300 dark:hover:text-zink-50 before:absolute before:border-b before:border-slate-500 dark:before:border-zink-500 before:inset-x-0 before:bottom-0 before:w-0 hover:before:w-full before:transition-all before:duration-300 before:ease-linear">Chat
                                App</a>
                        </li>
                        <li>
                            <a href="#!"
                                class="relative inline-block transition-all duration-200 ease-linear text-slate-400 dark:text-zink-200 hover:text-slate-300 dark:hover:text-zink-50 before:absolute before:border-b before:border-slate-500 dark:before:border-zink-500 before:inset-x-0 before:bottom-0 before:w-0 hover:before:w-full before:transition-all before:duration-300 before:ease-linear">Users
                                Apps</a>
                        </li>
                        <li>
                            <a href="#!"
                                class="relative inline-block transition-all duration-200 ease-linear text-slate-400 dark:text-zink-200 hover:text-slate-300 dark:hover:text-zink-50 before:absolute before:border-b before:border-slate-500 dark:before:border-zink-500 before:inset-x-0 before:bottom-0 before:w-0 hover:before:w-full before:transition-all before:duration-300 before:ease-linear">HR
                                Management</a>
                        </li>
                        <li>
                            <a href="#!"
                ...
                <div class="col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-2">
                    ...
                    <ul class="flex flex-col gap-3 text-15">
                        <li>
                            <a href="#!"
                                class="relative inline-block transition-all duration-200 ease-linear text-slate-400 dark:text-zink-200 hover:text-slate-300 dark:hover:text-zink-50 before:absolute before:border-b before:border-slate-500 dark:before:border-zink-500 before:inset-x-0 before:bottom-0 before:w-0 hover:before:w-full before:transition-all before:duration-300 before:ease-linear">All
                                Resources</a>
                        </li>
                        <li>
                            <a href="#!"
                        ...
                        <li>
                            <a href="#!"
                                class="relative inline-block transition-all duration-200 ease-linear text-slate-400 dark:text-zink-200 hover:text-slate-300 dark:hover:text-zink-50 before:absolute before:border-b before:border-slate-500 dark:before:border-zink-500 before:inset-x-0 before:bottom-0 before:w-0 hover:before:w-full before:transition-all before:duration-300 before:ease-linear">Help
                                Center</a>
                        </li>
                    </ul>
                </div><!--end col-->
                <div class="col-span-12 md:col-span-6 lg:col-span-12 xl:col-span-4">
                    <form action="#!" class="relative mb-6">
                        <input type="email" id="subscribeInput"
                            class="py-3 ltr:pr-40 rtl:pl-40 bg-slate-700/60 dark:bg-zink-600/40 form-input text-slate-200 border-slate-700 dark:border-zink-500 focus:outline-none focus:border-custom-500 dark:focus:border-custom-500 placeholder:text-slate-500 dark:placeholder:text-zink-200 backdrop-blur-md"
                            autocomplete="off" placeholder="tailwick@themesdesign.com" required>
                        <button type="submit"
                            class="absolute px-6 py-2 text-base transition-all duration-200 ease-linear border-custom-500 bg-custom-500 ltr:right-1 rtl:left-1 text-custom-50 btn hover:text-custom-50 hover:bg-custom-600 hover:border-custom-600 top-1 bottom-1">Subscribe
                            Now</button>
                    </form>
                ...
                <div class="relative z-10 grid grid-cols-1 gap-5 md:grid-cols-12">
                    <div class="md:col-span-2">
                        <div class="relative dropdown">
                            <button type="button"
                                class="inline-flex items-center gap-3 transition-all duration-200 ease-linear dropdown-toggle btn border-slate-700 group/items focus:border-custom-500"
                                id="dropdownMenuButton" data-bs-toggle="dropdown">
                                <img src="{{ URL::asset('build/images/flags/us.svg') }}" alt=""
                                    class="object-cover h-5 rounded-full">
                                <h6
                                    class="text-base font-medium transition-all duration-200 ease-linear text-slate-300 group-hover/items:text-custom-500">
                                    English</h6>
                            </button>
                            ...
                            <div class="absolute z-50 hidden p-3 mt-1 text-left list-none bg-white rounded-md shadow-md dropdown-menu min-w-[9rem] flex flex-col gap-3 dark:bg-zink-600"
                                ...
                                <a href="#!" class="flex items-center gap-3 group/items">
                                    ...
                                    <h6
                                        class="text-sm font-medium transition-all duration-200 ease-linear text-slate-600 dark:text-zink-100 group-hover/items:text-custom-500 dark:group-hover/items:text-custom-500">
                                        English</h6>
                                </a>
                                <a href="#!" class="flex items-center gap-3 group/items">
                    ...
                    <div class="md:col-span-3 md:col-start-10">
                        <ul class="flex items-center gap-3 md:justify-end">
                            <li>
                                <a href="#!"
                                    class="flex items-center justify-center w-10 h-10 transition-all duration-200 ease-linear border rounded-full text-slate-400 border-slate-700 hover:text-custom-500"><i
            ...
            <div class="mt-12 text-center text-slate-400 dark:text-zink-200 text-16">
                <p>
                    ...
                    </script> © Tailwick. Design & Develop by <a href="#!"
                        class="underline text-slate-300 dark:text-zink-100">Themesdesign</a>
                </p>
            </div>
        </div>
    </footer>
