                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="customDefaultSwitch" id="customDefaultSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-custom-500 dark:checked:border-custom-500 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="greenDefaultSwitch" id="greenDefaultSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-green-500 dark:checked:border-green-500 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="orangeDefaultSwitch" id="orangeDefaultSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-orange-500 dark:checked:border-orange-500 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="greenDefaultSwitch" id="skyDefaultSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-sky-500 dark:checked:border-sky-500 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="yellowDefaultSwitch" id="yellowDefaultSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-yellow-500 dark:checked:border-yellow-500 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="redDefaultSwitch" id="redDefaultSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-red-500 dark:checked:border-red-500 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="purpleDefaultSwitch" id="purpleDefaultSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-purple-500 dark:checked:border-purple-500 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="lightDefaultSwitch" id="lightDefaultSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-slate-400 dark:checked:border-slate-400 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="darkDefaultSwitch" id="darkDefaultSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-slate-700 dark:checked:border-slate-700 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="customSquareSwitch" id="customSquareSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-sm appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-custom-500 dark:checked:border-custom-500 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="greenSquareSwitch" id="greenSquareSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-sm appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-green-500 dark:checked:border-green-500 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="orangeSquareSwitch" id="orangeSquareSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-sm appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-orange-500 dark:checked:border-orange-500 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="greenSquareSwitch" id="skySquareSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-sm appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-sky-500 dark:checked:border-sky-500 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="yellowSquareSwitch" id="yellowSquareSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-sm appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-yellow-500 dark:checked:border-yellow-500 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="redSquareSwitch" id="redSquareSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-sm appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-red-500 dark:checked:border-red-500 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="purpleSquareSwitch" id="purpleSquareSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-sm appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-purple-500 dark:checked:border-purple-500 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="lightSquareSwitch" id="lightSquareSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-sm appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-slate-400 dark:checked:border-slate-400 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="darkSquareSwitch" id="darkSquareSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-sm appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-slate-700 dark:checked:border-slate-700 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="customSoftSwitch" id="customSoftSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-600 bg-white/80 dark:bg-zink-400 peer/published checked:bg-custom-500 dark:checked:bg-custom-500 ltr:checked:right-0 rtl:checked:left-0 checked:border-custom-100 dark:checked:border-custom-900 arrow-none checked:bg-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="greenSoftSwitch" id="greenSoftSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-600 bg-white/80 dark:bg-zink-400 peer/published checked:bg-green-500 dark:checked:bg-green-500 ltr:checked:right-0 rtl:checked:left-0 checked:border-green-100 dark:checked:border-green-900 arrow-none checked:bg-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="orangeSoftSwitch" id="orangeSoftSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-600 bg-white/80 dark:bg-zink-400 peer/published checked:bg-orange-500 dark:checked:bg-orange-500 ltr:checked:right-0 rtl:checked:left-0 checked:border-orange-100 dark:checked:border-orange-900 arrow-none checked:bg-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="greenSoftSwitch" id="skySoftSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-600 bg-white/80 dark:bg-zink-400 peer/published checked:bg-sky-500 dark:checked:bg-sky-500 ltr:checked:right-0 rtl:checked:left-0 checked:border-sky-100 arrow-none dark:checked:border-sky-900 checked:bg-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="yellowSoftSwitch" id="yellowSoftSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-600 bg-white/80 dark:bg-zink-400 peer/published checked:bg-yellow-500 dark:checked:bg-yellow-500 ltr:checked:right-0 rtl:checked:left-0 checked:border-yellow-100 dark:checked:border-yellow-900 arrow-none checked:bg-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="redSoftSwitch" id="redSoftSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-600 bg-white/80 dark:bg-zink-400 peer/published checked:bg-red-500 dark:checked:bg-red-500 ltr:checked:right-0 rtl:checked:left-0 checked:border-red-100 dark:checked:border-red-900 arrow-none checked:bg-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="purpleSoftSwitch" id="purpleSoftSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-600 bg-white/80 dark:bg-zink-400 peer/published checked:bg-purple-500 dark:checked:bg-purple-500 ltr:checked:right-0 rtl:checked:left-0 checked:border-purple-100 dark:checked:border-purple-900 arrow-none checked:bg-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="lightSoftSwitch" id="lightSoftSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-600 bg-white/80 dark:bg-zink-400 peer/published checked:bg-slate-500 dark:checked:bg-zink-500 ltr:checked:right-0 rtl:checked:left-0 checked:border-slate-200 dark:checked:border-zink-200 arrow-none checked:bg-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="darkSoftSwitch" id="darkSoftSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-600 bg-white/80 dark:bg-zink-400 peer/published checked:bg-slate-500 dark:checked:bg-zink-300 ltr:checked:right-0 rtl:checked:left-0 checked:border-slate-400 dark:checked:border-zink-500 arrow-none checked:bg-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="customOutlineSwitch" id="customOutlineSwitch"
                                class="absolute block w-4 h-4 top-0.5 transition duration-300 ease-linear border-2 border-white rounded-full dark:border-zink-700 appearance-none cursor-pointer bg-slate-200 peer/published dark:bg-zink-500 checked:bg-custom-500 dark:checked:bg-custom-500 ltr:checked:right-0.5 rtl:checked:left-0.5 checked:left-auto checked:border-white dark:checked:border-zink-700 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="greenOutlineSwitch" id="greenOutlineSwitch"
                                class="absolute block w-4 h-4 top-0.5 transition duration-300 ease-linear border-2 border-white rounded-full dark:border-zink-700 appearance-none cursor-pointer bg-slate-200 peer/published dark:bg-zink-500 checked:bg-green-500  dark:checked:bg-green-500 ltr:checked:right-0.5 rtl:checked:left-0.5 checked:left-auto checked:border-white dark:checked:border-zink-700 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="orangeOutlineSwitch" id="orangeOutlineSwitch"
                                class="absolute block w-4 h-4 top-0.5 transition duration-300 ease-linear border-2 border-white rounded-full dark:border-zink-700 appearance-none cursor-pointer bg-slate-200 peer/published dark:bg-zink-500 checked:bg-orange-500 dark:checked:bg-orange-500 ltr:checked:right-0.5 rtl:checked:left-0.5 checked:left-auto checked:border-white dark:checked:border-zink-700 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="skyOutlineSwitch" id="skyOutlineSwitch"
                                class="absolute block w-4 h-4 top-0.5 transition duration-300 ease-linear border-2 border-white rounded-full dark:border-zink-700 appearance-none cursor-pointer bg-slate-200 peer/published dark:bg-zink-500 checked:bg-sky-500 dark:checked:bg-sky-500 ltr:checked:right-0.5 rtl:checked:left-0.5 checked:left-auto checked:border-white dark:checked:border-zink-700 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="yellowOutlineSwitch" id="yellowOutlineSwitch"
                                class="absolute block w-4 h-4 top-0.5 transition duration-300 ease-linear border-2 border-white rounded-full dark:border-zink-700 appearance-none cursor-pointer bg-slate-200 peer/published dark:bg-zink-500 checked:bg-yellow-500 dark:checked:bg-yellow-500 ltr:checked:right-0.5 rtl:checked:left-0.5 checked:left-auto checked:border-white dark:checked:border-zink-700 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="redOutlineSwitch" id="redOutlineSwitch"
                                class="absolute block w-4 h-4 top-0.5 transition duration-300 ease-linear border-2 border-white rounded-full dark:border-zink-700 appearance-none cursor-pointer bg-slate-200 peer/published dark:bg-zink-500 checked:bg-red-500 dark:checked:bg-red-500 ltr:checked:right-0.5 rtl:checked:left-0.5 checked:left-auto checked:border-white dark:checked:border-zink-700 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="purpleOutlineSwitch" id="purpleOutlineSwitch"
                                class="absolute block w-4 h-4 top-0.5 transition duration-300 ease-linear border-2 border-white rounded-full dark:border-zink-700 appearance-none cursor-pointer bg-slate-200 peer/published dark:bg-zink-500 checked:bg-purple-500 dark:checked:bg-purple-500 ltr:checked:right-0.5 rtl:checked:left-0.5 checked:left-auto checked:border-white dark:checked:border-zink-700 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="lightOutlineSwitch" id="lightOutlineSwitch"
                                class="absolute block w-4 h-4 top-0.5 transition duration-300 ease-linear border-2 border-white rounded-full dark:border-zink-700 appearance-none cursor-pointer bg-slate-200 peer/published dark:bg-zink-500 checked:bg-slate-400 dark:checked:bg-zink-400 ltr:checked:right-0.5 rtl:checked:left-0.5 checked:left-auto checked:border-white dark:checked:border-zink-700 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="darkOutlineSwitch" id="darkOutlineSwitch"
                                class="absolute block w-4 h-4 top-0.5 transition duration-300 ease-linear border-2 border-white rounded-full dark:border-zink-700 appearance-none cursor-pointer bg-slate-200 peer/published dark:bg-zink-500 checked:bg-slate-700 dark:checked:bg-zink-500 ltr:checked:right-0.5 rtl:checked:left-0.5 checked:left-auto checked:border-white dark:checked:border-zink-700 arrow-none"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="customIconSwitch" id="customIconSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 border-slate-200 dark:border-zink-500 rounded-full appearance-none cursor-pointer bg-white/80 dark:bg-zink-600 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-custom-500 dark:checked:border-custom-500 arrow-none after:absolute after:text-slate-500 dark:after:text-zink-200 after:content-['\eb99'] after:text-xs after:inset-0 after:flex after:items-center after:justify-center after:font-remix after:leading-none checked:after:text-custom-500 dark:checked:after:text-custom-500 checked:after:content-['\eb7b']"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="greenIconSwitch" id="greenIconSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 border-slate-200 dark:border-zink-500 rounded-full appearance-none cursor-pointer bg-white/80 dark:bg-zink-600 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-green-500 dark:checked:border-green-500 arrow-none after:absolute after:text-slate-500 dark:after:text-zink-200 after:content-['\eb99'] after:text-xs after:inset-0 after:flex after:items-center after:justify-center after:font-remix after:leading-none checked:after:text-green-500 dark:checked:after:text-green-500 checked:after:content-['\eb7b']"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="orangeIconSwitch" id="orangeIconSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 border-slate-200 dark:border-zink-500 rounded-full appearance-none cursor-pointer bg-white/80 dark:bg-zink-600 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-orange-500 dark:checked:border-orange-500 arrow-none after:absolute after:text-slate-500 dark:after:text-zink-200 after:content-['\eb99'] after:text-xs after:inset-0 after:flex after:items-center after:justify-center after:font-remix after:leading-none checked:after:text-orange-500 dark:checked:after:text-orange-500 checked:after:content-['\eb7b']"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="skyIconSwitch" id="skyIconSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 border-slate-200 dark:border-zink-500 rounded-full appearance-none cursor-pointer bg-white/80 dark:bg-zink-600 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-sky-500 dark:checked:border-sky-500 arrow-none after:absolute after:text-slate-500 dark:after:text-zink-200 after:content-['\eb99'] after:text-xs after:inset-0 after:flex after:items-center after:justify-center after:font-remix after:leading-none checked:after:text-sky-500 dark:checked:after:text-sky-500 checked:after:content-['\eb7b']"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="yellowIconSwitch" id="yellowIconSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 border-slate-200 dark:border-zink-500 rounded-full appearance-none cursor-pointer bg-white/80 dark:bg-zink-600 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-yellow-500 dark:checked:border-yellow-500 arrow-none after:absolute after:text-slate-500 dark:after:text-zink-200 after:content-['\eb99'] after:text-xs after:inset-0 after:flex after:items-center after:justify-center after:font-remix after:leading-none checked:after:text-yellow-500 dark:checked:after:text-yellow-500 checked:after:content-['\eb7b']"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="redIconSwitch" id="redIconSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 border-slate-200 dark:border-zink-500 rounded-full appearance-none cursor-pointer bg-white/80 dark:bg-zink-600 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-red-500 dark:checked:border-red-500 arrow-none after:absolute after:text-slate-500 dark:after:text-zink-200 after:content-['\eb99'] after:text-xs after:inset-0 after:flex after:items-center after:justify-center after:font-remix after:leading-none checked:after:text-red-500 dark:checked:after:text-red-500 checked:after:content-['\eb7b']"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="purpleIconSwitch" id="purpleIconSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 border-slate-200 dark:border-zink-500 rounded-full appearance-none cursor-pointer bg-white/80 dark:bg-zink-600 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-purple-500 dark:checked:border-purple-500 arrow-none after:absolute after:text-slate-500 dark:after:text-zink-200 after:content-['\eb99'] after:text-xs after:inset-0 after:flex after:items-center after:justify-center after:font-remix after:leading-none checked:after:text-purple-500 dark:checked:after:text-purple-500 checked:after:content-['\eb7b']"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="lightIconSwitch" id="lightIconSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 border-slate-200 dark:border-zink-500 rounded-full appearance-none cursor-pointer bg-white/80 dark:bg-zink-600 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-slate-400 dark:checked:border-slate-400 arrow-none after:absolute after:text-slate-500 dark:after:text-zink-200 after:content-['\eb99'] after:text-xs after:inset-0 after:flex after:items-center after:justify-center after:font-remix after:leading-none checked:after:text-slate-400 dark:checked:after:text-slate-400 checked:after:content-['\eb7b']"
                                checked>
                    ...
                    <div class="flex items-center">
                        <div
                            ...
                            <input type="checkbox" name="darkIconSwitch" id="darkIconSwitch"
                                class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 border-slate-200 dark:border-zink-500 rounded-full appearance-none cursor-pointer bg-white/80 dark:bg-zink-600 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-slate-700 dark:checked:border-slate-700 arrow-none after:absolute after:text-slate-500 dark:after:text-zink-200 after:content-['\eb99'] after:text-xs after:inset-0 after:flex after:items-center after:justify-center after:font-remix after:leading-none checked:after:text-slate-700 dark:checked:after:text-slate-700 checked:after:content-['\eb7b']"
                                checked>
                        ...
                        <div class="flex items-center">
                            <div
                                ...
                                <input type="checkbox" name="sizeSwitch" id="sizeSwitch"
                                    class="absolute block w-4 h-4 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-custom-500 dark:checked:border-custom-500 arrow-none"
                                    checked>
                        ...
                        <div class="flex items-center">
                            <div
                                ...
                                <input type="checkbox" name="sizeSwitch3" id="sizeSwitch3"
                                    class="absolute block w-6 h-6 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-orange-500 dark:checked:border-orange-500 arrow-none"
                                    checked>
                        ...
                        <div class="flex items-center">
                            <div
                                ...
                                <input type="checkbox" name="disabledSwitch" id="disabledSwitch"
                                    class="absolute block w-4 h-4 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-auto border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-custom-500 dark:checked:border-custom-500 arrow-none"
                                    disabled>
                        ...
                        <div class="flex items-center">
                            <div
                                ...
                                <input type="checkbox" name="disabledSwitch2" id="disabledSwitch2"
                                    class="absolute block w-5 h-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-auto border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-green-500 dark:checked:border-green-500 arrow-none"
                                    checked disabled>
                        ...
                        <div class="flex items-center">
                            <div
                                ...
                                <input type="checkbox" name="disabledSwitch3" id="disabledSwitch3"
                                    class="absolute block w-6 h-6 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-auto border-slate-200 dark:border-zink-500 bg-white/80 dark:bg-zink-400 peer/published checked:bg-white dark:checked:bg-white ltr:checked:right-0 rtl:checked:left-0 checked:bg-none checked:border-orange-500 dark:checked:border-orange-500 arrow-none"
                                    checked disabled>
