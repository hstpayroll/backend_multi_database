...
@section('content')
    ...
    <nav
        ...
        <ul class="flex items-center ltr:ml-auto rtl:mr-auto">
            <li>
                <a href="#!"
                    class="inline-flex items-center justify-center w-10 h-10 transition-all duration-300 ease-linear tems-center text-slate-500 hover:text-custom-500 active:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:active:text-custom-500 group/item"><i
                        data-lucide="shopping-bag"
                        class="w-4 h-4 fill-slate-50 dark:fill-zink-500 group-hover/item:fill-custom-50 dark:group-hover/item:fill-custom-500/20"></i></a>
            </li>
            <li>
                <a href="#!"
                    class="inline-flex items-center justify-center w-10 h-10 transition-all duration-300 ease-linear tems-center text-slate-500 hover:text-custom-500 active:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:active:text-custom-500 group/item"><i
    ...
    <nav
        ...
        <ul id="navbar4" class="flex items-center ltr:ml-auto rtl:mr-auto">
            <li>
                <a href="#!"
                    class="inline-flex items-center justify-center w-10 h-10 transition-all duration-300 ease-linear tems-center text-slate-400 hover:text-custom-500 active:text-custom-500 group/item dark:text-zink-200 dark:hover:text-custom-500 dark:active:text-custom-500"><i
                        data-lucide="search"
                        class="w-4 h-4 fill-slate-50/10 group-hover/item:fill-custom-400/20 dark:fill-zink-500"></i></a>
            </li>
            <li>
                <a href="#!"
                    class="inline-flex items-center justify-center w-10 h-10 transition-all duration-300 ease-linear tems-center text-slate-400 hover:text-custom-500 active:text-custom-500 group/item dark:text-zink-200 dark:hover:text-custom-500 dark:active:text-custom-500"><i
