    ...
    <div class="col-md-6">
        <div class="form-group required">
            ...
            <input name="name" type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}"
                id="name" value="{{ old('name') ?? $customer->name }}" onfocusout="validateName()">
            @error('name')
        ...
        <div class="form-group row">
            ...
            <input name="officenumber" type="text"
                ...
                value="{{ old('officenumber') ?? $customer->officenumber }}" onfocusout=" validateOfficenumber()">
            @error('officenumber')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="form-group row">
            ...
            <input name="mobile" type="text" class="form-control {{ $errors->has('mobile') ? ' is-invalid' : '' }}"
                id="mobile" value="{{ old('mobile') ?? $customer->mobile }}" onfocusout="validateMobile()">
